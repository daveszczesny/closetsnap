 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ho=new Map,ul=new Map;function TT(t,e){try{t.container.addComponent(e)}catch(n){Es.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function jn(t){const e=t.name;if(ul.has(e))return Es.debug(`There were multiple attempts to register component ${e}.`),!1;ul.set(e,t);for(const n of Ho.values())TT(n,t);return!0}function Oi(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ST="firebase-heartbeat-database",CT=1,ri="firebase-heartbeat-store";let gc=null;function mg(){return gc||(gc=KE(ST,CT,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(ri)}}}).catch(t=>{throw Ln.create("idb-open",{originalErrorMessage:t.message})})),gc}async function kT(t){try{return(await mg()).transaction(ri).objectStore(ri).get(yg(t))}catch(e){if(e instanceof en)Es.warn(e.message);else{const n=Ln.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Es.warn(n.message)}}}async function dd(t,e){try{const s=(await mg()).transaction(ri,"readwrite");return await s.objectStore(ri).put(e,yg(t)),s.done}catch(n){if(n instanceof en)Es.warn(n.message);else{const s=Ln.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Es.warn(s.message)}}}function yg(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ts=new fu("@firebase/firestore");function Rd(){return Ts.logLevel}function B(t,...e){if(Ts.logLevel<=pe.DEBUG){const n=e.map(Lu);Ts.debug(`Firestore (${gr}): ${t}`,...n)}}function mn(t,...e){if(Ts.logLevel<=pe.ERROR){const n=e.map(Lu);Ts.error(`Firestore (${gr}): ${t}`,...n)}}function Jo(t,...e){if(Ts.logLevel<=pe.WARN){const n=e.map(Lu);Ts.warn(`Firestore (${gr}): ${t}`,...n)}}function Lu(t){if(typeof t=="string")return t;try{return e=t,JSON.stringify(e)}catch{return t}/**
* @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const v0=new ze(H.comparator);function vn(){return v0}const Mm=new ze(H.comparator);function Lr(...t){let e=Mm;for(const n of t)e=e.insert(n.key,n);return e}function Lm(t){let e=Mm;return t.forEach((n,s)=>e=e.insert(n,s.overlayedDocument)),e}function ls(){return zr()}function Um(){return zr()}function zr(){return new yr(t=>t.toString(),(t,e)=>t.isEqual(e))}const _0=new ze(H.comparator),w0=new qe(H.comparator);function ce(...t){let e=w0;for(const n of t)e=e.add(n);return e}const b0=new qe(me);function Fm(){return b0}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
${JSON.stringify(F,null,2)}
 when navigating to "${_.fullPath}". A redirect must contain a name or path. This will break in production.`),new Error("Invalid redirect");return ge({query:_.query,hash:_.hash,params:"path"in F?{}:_.params},F)}}function Te(_,L){const x=l=C(_),F=c.value,he=_.state,be=_.force,se=_.replace===!0,ee=ue(x);if(ee)return Te(ge(O(ee),{state:typeof ee=="object"?ge({},he,ee.state):he,force:be,replace:se}),L||x);const f=x;f.redirectedFrom=L;let g;return!be&&cf(s,F,x)&&(g=hr(16,{to:f,from:F}),xs(F,F,!0,!1)),(g?Promise.resolve(g):re(f,F)).catch(y=>nn(y)?nn(y,2)?y:gt(y):ie(y,f,F)).then(y=>{if(y){if(nn(y,2))return cf(s,C(y.to),f)&&L&&(L._count=L._count?L._count+1:1)>10?(fe(`Detected an infinite redirection in a navigation guard when going from "${F.fullPath}" to "${f.fullPath}". Aborting to avoid a Stack Overflow. This will break in production if not fixed.`),Promise.reject(new Error("Infinite redirect in navigation guard"))):Te(ge({replace:se},O(y.to),{state:typeof y.to=="object"?ge({},he,y.to.state):he,force:be}),L||f)}else y=Fe(f,F,!0,se,he);return ye(f,F,y),y})}function z(_,L){const x=D(_,L);return x?Promise.reject(x):Promise.resolve()}function re(_,L){let x;const[F,he,be]=Ok(_,L);x=Oc(F.reverse(),"beforeRouteLeave",_,L);for(const ee of F)ee.leaveGuards.forEach(f=>{x.push(Cn(f,_,L))});const se=z.bind(null,_,L);return x.push(se),Fs(x).then(()=>{x=[];for(const ee of i.list())x.push(Cn(ee,_,L));return x.push(se),Fs(x)}).then(()=>{x=Oc(he,"beforeRouteUpdate",_,L);for(const ee of he)ee.updateGuards.forEach(f=>{x.push(Cn(f,_,L))});return x.push(se),Fs(x)}).then(()=>{x=[];for(const ee of _.matched)if(ee.beforeEnter&&!L.matched.includes(ee))if(bt(ee.beforeEnter))for(const f of ee.beforeEnter)x.push(Cn(f,_,L));else x.push(Cn(ee.beforeEnter,_,L));return x.push(se),Fs(x)}).then(()=>(_.matched.forEach(ee=>ee.enterCallbacks={}),x=Oc(be,"beforeRouteEnter",_,L),x.push(se),Fs(x))).then(()=>{x=[];for(const ee of o.list())x.push(Cn(ee,_,L));return x.push(se),Fs(x)}).catch(ee=>nn(ee,8)?ee:Promise.reject(ee))}function ye(_,L,x){for(const F of a.list())F(_,L,x)}function Fe(_,L,x,F,he){const be=D(_,L);if(be)return be;const se=L===Tn,ee=on?history.state:{};x&&(F||se?r.replace(_.fullPath,ge({scroll:se&&ee&&ee.scroll},he)):r.push(_.fullPath,he)),c.value=_,xs(_,L,x,se),gt()}let ke;function Ot(){ke||(ke=r.listen((_,L,x)=>{if(!Ms.listening)return;const F=C(_),he=ue(F);if(he){Te(ge(he,{replace:!0}),F).catch(Wr);return}l=F;const be=c.value;on&&TC(uf(be.fullPath,x.delta),Za()),re(F,be).catch(se=>nn(se,12)?se:nn(se,2)?(Te(se.to,F).then(ee=>{nn(ee,20)&&!x.delta&&x.type===yi.pop&&r.go(-1,!1)}).catch(Wr),Promise.reject()):(x.delta&&r.go(-x.delta,!1),ie(se,F,be))).then(se=>{se=se||Fe(F,be,!1),se&&(x.delta&&!nn(se,8)?r.go(-x.delta,!1):x.type===yi.pop&&nn(se,20)&&r.go(-1,!1)),ye(F,be,se)}).catch(Wr)}))}let bn=Ar(),Nt=Ar(),$e;function ie(_,L,x){gt(_);const F=Nt.list();return F.length?F.forEach(he=>he(_,L,x)):(fe("uncaught error during route navigation:"),console.error(_)),Promise.reject(_)}function le(){return $e&&c.value!==Tn?Promise.resolve():new Promise((_,L)=>{bn.add([_,L])})}function gt(_){return $e||($e=!_,Ot(),bn.list().forEach(([L,x])=>_?x(_):L()),bn.reset()),_}function xs(_,L,x,F){const{scrollBehavior:he}=t;if(!on||!he)return Promise.resolve();const be=!x&&IC(uf(_.fullPath,0))||(F||!x)&&history.state&&history.state.scroll||null;return Ep().then(()=>he(_,L,be)).then(se=>se&&EC(se)).catch(se=>ie(se,_,L))}const tn=_=>r.go(_);let Ft;const Et=new Set,Ms={currentRoute:c,listening:!0,addRoute:p,removeRoute:m,hasRoute:w,getRoutes:v,resolve:C,options:t,push:P,replace:q,go:tn,back:()=>tn(-1),forward:()=>tn(1),beforeEach:i.add,beforeResolve:o.add,afterEach:a.add,onError:Nt.add,isReady:le,install(_){const L=this;_.component("RouterLink",pk),_.component("RouterView",vk),_.config.globalProperties.$router=L,Object.defineProperty(_.config.globalProperties,"$route",{enumerable:!0,get:()=>Xs(c)}),on&&!Ft&&c.value===Tn&&(Ft=!0,P(r.location).catch(he=>{fe("Unexpected error when starting the router:",he)}));const x={};for(const he in Tn)x[he]=At(()=>c.value[he]);_.provide(ah,L),_.provide(qy,Ii(x)),_.provide(Ul,c);const F=_.unmount;Et.add(_),_.unmount=function(){Et.delete(_),Et.size<1&&(l=Tn,ke&&ke(),ke=null,c.value=Tn,Ft=!1,$e=!1),F()},on&&bk(_,L,e)}};return Ms}function Fs(t){return t.reduce((e,n)=>e.then(()=>n()),Promise.resolve())}function Ok(t,e){const n=[],s=[],r=[],i=Math.max(e.matched.length,t.matched.length);for(let o=0;o<i;o++){const a=e.matched[o];a&&(t.matched.find(l=>Kn(l,a))?s.push(a):n.push(a));const c=t.matched[o];c&&(e.matched.find(l=>Kn(l,c))||r.push(c))}return[n,s,r]}const Nk="modulepreload",Pk=function(t){return"/"+t},If={},Jn=function(e,n,s){if(!n||n.length===0)return e();const r=document.getElementsByTagName("link");return Promise.all(n.map(i=>{if(i=Pk(i),i in If)return;If[i]=!0;const o=i.endsWith(".css"),a=o?'[rel="stylesheet"]':"";if(!!s)for(let u=r.length-1;u>=0;u--){const h=r[u];if(h.href===i&&(!o||h.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${i}"]${a}`))return;const l=document.createElement("link");if(l.rel=o?"stylesheet":Nk,o||(l.as="script",l.crossOrigin=""),l.href=i,document.head.appendChild(l),o)return new Promise((u,h)=>{l.addEventListener("load",u),l.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${i}`)))})})).then(()=>e())},Dk=(t,e)=>{const n=t[e];return n?typeof n=="function"?n():Promise.resolve(n):new Promise((s,r)=>{(typeof queueMicrotask=="function"?queueMicrotask:setTimeout)(r.bind(null,new Error("Unknown variable dynamic import: "+e)))})};function Zn(t){return()=>Dk(Object.assign({"../pages/About.vue":()=>Jn(()=>import("./About-bd82421d.js"),["assets/About-bd82421d.js","assets/About-b73b4ef9.css"]),"../pages/Account.vue":()=>Jn(()=>import("./Account-643fb1e3.js"),["assets/Account-643fb1e3.js","assets/auth_signout-b22d4e30.js"]),"../pages/AddCloset.vue":()=>Jn(()=>import("./AddCloset-a5f1f584.js"),["assets/AddCloset-a5f1f584.js","assets/AddCloset-4b4b8398.css"]),"../pages/Closet.vue":()=>Jn(()=>import("./Closet-66d4fb9c.js"),["assets/Closet-66d4fb9c.js","assets/auth_signout-b22d4e30.js","assets/Closet-2d294a74.css"]),"../pages/CreateAccount.vue":()=>Jn(()=>import("./CreateAccount-412c5757.js"),["assets/CreateAccount-412c5757.js","assets/arrow_right-99ae10ae.js","assets/CreateAccount-ad3ca745.css"]),"../pages/Home.vue":()=>Jn(()=>import("./Home-8b03b1bc.js"),["assets/Home-8b03b1bc.js","assets/Home-56efbfe4.css"]),"../pages/Login.vue":()=>Jn(()=>import("./Login-294afe6c.js"),["assets/Login-294afe6c.js","assets/auth_signout-b22d4e30.js","assets/arrow_right-99ae10ae.js","assets/Login-04ef15d7.css"])}),`../pages/${t}.vue`)}const xk=[{path:"/",component:Zn("Home")},{path:"/About",component:Zn("About")},{path:"/Closet",component:Zn("Closet")},{path:"/Login",component:Zn("Login")},{path:"/AddCloset",component:Zn("AddCloset")},{path:"/Account",component:Zn("Account")},{path:"/CreateAccount",component:Zn("CreateAccount")}];var Mk="firebase",Lk="9.19.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rn extends Yi{constructor(){super("facebook.com")}static credential(e){return As._fromParams({providerId:Rn.PROVIDER_ID,signInMethod:Rn.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Rn.credentialFromTaggedObject(e)}static credentialFromError(e){return Rn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Rn.credential(e.oauthAccessToken)}catch{return null}}}Rn.FACEBOOK_SIGN_IN_METHOD="facebook.com";Rn.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nn extends Yi{constructor(){super("github.com")}static credential(e){return As._fromParams({providerId:Nn.PROVIDER_ID,signInMethod:Nn.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Nn.credentialFromTaggedObject(e)}static credentialFromError(e){return Nn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Nn.credential(e.oauthAccessToken)}catch{return null}}}Nn.GITHUB_SIGN_IN_METHOD="github.com";Nn.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ss{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,n,s,r=!1){const i=await vs._fromIdTokenResponse(e,s,r),o=Pf(s);return new Ss({user:i,providerId:o,_tokenResponse:s,operationType:n})}static async _forOperation(e,n,s){await e._updateTokensIfNecessary(s,!0);const r=Pf(s);return new Ss({user:e,providerId:r,_tokenResponse:s,operationType:n})}}function Pf(t){return t.providerId?t.providerId:"phoneNumber"in t?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wR(t,e,n=!1){const{auth:s}=t,r="reauthenticate";try{const i=await _i(t,gv(s,r,e,t),n);W(i.idToken,s,"internal-error");const o=hh(i.idToken);W(o,s,"internal-error");const{sub:a}=o;return W(t.uid===a,s,"user-mismatch"),Ss._forOperation(t,r,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&Ut(s,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function mv(t,e,n=!1){const s="signIn",r=await gv(t,s,e),i=await Ss._fromIdTokenResponse(t,s,r);return n||await t._updateCurrentUser(i.user),i}async function bR(t,e){return mv(Xi(t),e)}async function bP(t,e,n){const s=Xi(t),r=await vR(s,{returnSecureToken:!0,email:e,password:n}),i=await Ss._fromIdTokenResponse(s,"signIn",r);return await s._updateCurrentUser(i.user),i}function EP(t,e,n){return bR(Ue(t),_r.credential(e,n))}function ER(t,e,n,s){return Ue(t).onIdTokenChanged(e,n,s)}function TR(t,e,n){return Ue(t).beforeAuthStateChanged(e,n)}function TP(t){return Ue(t).signOut()}const ca="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cs{constructor(e,n){this._service=e,n instanceof pt?this._location=n:this._location=pt.makeFromUrl(n,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,n){return new Cs(e,n)}get root(){const e=new pt(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Fv(this._location.path)}get storage(){return this._service}get parent(){const e=wN(this._location.path);if(e===null)return null;const n=new pt(this._location.bucket,e);return new Cs(this._service,n)}_throwIfRoot(e){if(this._location.path==="")throw JO(e)}}function HN(t,e,n){return t._throwIfRoot("uploadBytesResumable"),new jN(t,new Dn(e),n)}function qN(t,e){e!=null&&typeof e.maxResults=="number"&&jl("options.maxResults",1,1e3,e.maxResults);const n=e||{},s=PN(t.storage,t._location,"/",n.pageToken,n.maxResults);return t.storage.makeRequestWithTokens(s,is)}function zN(t){t._throwIfRoot("getDownloadURL");const e=DN(t.storage,t._location,$v());return t.storage.makeRequestWithTokens(e,is).then(n=>{if(n===null)throw XO();return n})}function KN(t,e){const n=bN(t._location.path,e),s=new pt(t._location.bucket,n);return new Cs(t.storage,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
