(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function n(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(r){if(r.ep)return;r.ep=!0;const i=n(r);fetch(r.href,i)}})();function Gn(t,e){const n=Object.create(null),s=t.split(",");for(let r=0;r<s.length;r++)n[s[r]]=!0;return e?r=>!!n[r.toLowerCase()]:r=>!!n[r]}function ql(t){if(W(t)){const e={};for(let n=0;n<t.length;n++){const s=t[n],r=De(s)?t_(s):ql(s);if(r)for(const i in r)e[i]=r[i]}return e}else{if(De(t))return t;if(we(t))return t}}const Jv=/;(?![^(]*\))/g,Zv=/:([^]+)/,e_=/\/\*.*?\*\//gs;function t_(t){const e={};return t.replace(e_,"").split(Jv).forEach(n=>{if(n){const s=n.split(Zv);s.length>1&&(e[s[0].trim()]=s[1].trim())}}),e}function Ei(t){let e="";if(De(t))e=t;else if(W(t))for(let n=0;n<t.length;n++){const s=Ei(t[n]);s&&(e+=s+" ")}else if(we(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const n_="html,body,base,head,link,meta,style,title,address,article,aside,footer,header,hgroup,h1,h2,h3,h4,h5,h6,nav,section,div,dd,dl,dt,figcaption,figure,picture,hr,img,li,main,ol,p,pre,ul,a,b,abbr,bdi,bdo,br,cite,code,data,dfn,em,i,kbd,mark,q,rp,rt,ruby,s,samp,small,span,strong,sub,sup,time,u,var,wbr,area,audio,map,track,video,embed,object,param,source,canvas,script,noscript,del,ins,caption,col,colgroup,table,thead,tbody,td,th,tr,button,datalist,fieldset,form,input,label,legend,meter,optgroup,option,output,progress,select,textarea,details,dialog,menu,summary,template,blockquote,iframe,tfoot",s_="svg,animate,animateMotion,animateTransform,circle,clipPath,color-profile,defs,desc,discard,ellipse,feBlend,feColorMatrix,feComponentTransfer,feComposite,feConvolveMatrix,feDiffuseLighting,feDisplacementMap,feDistantLight,feDropShadow,feFlood,feFuncA,feFuncB,feFuncG,feFuncR,feGaussianBlur,feImage,feMerge,feMergeNode,feMorphology,feOffset,fePointLight,feSpecularLighting,feSpotLight,feTile,feTurbulence,filter,foreignObject,g,hatch,hatchpath,image,line,linearGradient,marker,mask,mesh,meshgradient,meshpatch,meshrow,metadata,mpath,path,pattern,polygon,polyline,radialGradient,rect,set,solidcolor,stop,switch,symbol,text,textPath,title,tspan,unknown,use,view",r_=Gn(n_),i_=Gn(s_),o_="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",a_=Gn(o_);function Jf(t){return!!t||t===""}const gP=t=>De(t)?t:t==null?"":W(t)||we(t)&&(t.toString===np||!Q(t.toString))?JSON.stringify(t,Zf,2):String(t),Zf=(t,e)=>e&&e.__v_isRef?Zf(t,e.value):hs(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[s,r])=>(n[`${s} =>`]=r,n),{})}:tp(e)?{[`Set(${e.size})`]:[...e.values()]}:we(e)&&!W(e)&&!sp(e)?String(e):e,_e=Object.freeze({}),Xs=Object.freeze([]),vt=()=>{},ep=()=>!1,c_=/^on[^a-z]/,Ti=t=>c_.test(t),xo=t=>t.startsWith("onUpdate:"),Pe=Object.assign,zl=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},l_=Object.prototype.hasOwnProperty,oe=(t,e)=>l_.call(t,e),W=Array.isArray,hs=t=>ha(t)==="[object Map]",tp=t=>ha(t)==="[object Set]",Q=t=>typeof t=="function",De=t=>typeof t=="string",Kl=t=>typeof t=="symbol",we=t=>t!==null&&typeof t=="object",Wl=t=>we(t)&&Q(t.then)&&Q(t.catch),np=Object.prototype.toString,ha=t=>np.call(t),Gl=t=>ha(t).slice(8,-1),sp=t=>ha(t)==="[object Object]",Ql=t=>De(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,_o=Gn(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),u_=Gn("bind,cloak,else-if,else,for,html,if,model,on,once,pre,show,slot,text,memo"),da=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},h_=/-(\w)/g,Xt=da(t=>t.replace(h_,(e,n)=>n?n.toUpperCase():"")),d_=/\B([A-Z])/g,Bn=da(t=>t.replace(d_,"-$1").toLowerCase()),Es=da(t=>t.charAt(0).toUpperCase()+t.slice(1)),ns=da(t=>t?`on${Es(t)}`:""),Yr=(t,e)=>!Object.is(t,e),js=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},Mo=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},Lc=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let kh;const rp=()=>kh||(kh=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Uc(t,...e){console.warn(`[Vue warn] ${t}`,...e)}let Dt;class f_{constructor(e=!1){this.detached=e,this._active=!0,this.effects=[],this.cleanups=[],this.parent=Dt,!e&&Dt&&(this.index=(Dt.scopes||(Dt.scopes=[])).push(this)-1)}get active(){return this._active}run(e){if(this._active){const n=Dt;try{return Dt=this,e()}finally{Dt=n}}else Uc("cannot run an inactive effect scope.")}on(){Dt=this}off(){Dt=this.parent}stop(e){if(this._active){let n,s;for(n=0,s=this.effects.length;n<s;n++)this.effects[n].stop();for(n=0,s=this.cleanups.length;n<s;n++)this.cleanups[n]();if(this.scopes)for(n=0,s=this.scopes.length;n<s;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!e){const r=this.parent.scopes.pop();r&&r!==this&&(this.parent.scopes[this.index]=r,r.index=this.index)}this.parent=void 0,this._active=!1}}}function p_(t,e=Dt){e&&e.active&&e.effects.push(t)}function g_(){return Dt}const Xl=t=>{const e=new Set(t);return e.w=0,e.n=0,e},ip=t=>(t.w&Vn)>0,op=t=>(t.n&Vn)>0,m_=({deps:t})=>{if(t.length)for(let e=0;e<t.length;e++)t[e].w|=Vn},y_=t=>{const{deps:e}=t;if(e.length){let n=0;for(let s=0;s<e.length;s++){const r=e[s];ip(r)&&!op(r)?r.delete(t):e[n++]=r,r.w&=~Vn,r.n&=~Vn}e.length=n}},Fc=new WeakMap;let kr=0,Vn=1;const $c=30;let ht;const ds=Symbol("iterate"),Bc=Symbol("Map key iterate");class Yl{constructor(e,n=null,s){this.fn=e,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,p_(this,s)}run(){if(!this.active)return this.fn();let e=ht,n=Mn;for(;e;){if(e===this)return;e=e.parent}try{return this.parent=ht,ht=this,Mn=!0,Vn=1<<++kr,kr<=$c?m_(this):Rh(this),this.fn()}finally{kr<=$c&&y_(this),Vn=1<<--kr,ht=this.parent,Mn=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){ht===this?this.deferStop=!0:this.active&&(Rh(this),this.onStop&&this.onStop(),this.active=!1)}}function Rh(t){const{deps:e}=t;if(e.length){for(let n=0;n<e.length;n++)e[n].delete(t);e.length=0}}let Mn=!0;const ap=[];function Os(){ap.push(Mn),Mn=!1}function Ns(){const t=ap.pop();Mn=t===void 0?!0:t}function _t(t,e,n){if(Mn&&ht){let s=Fc.get(t);s||Fc.set(t,s=new Map);let r=s.get(n);r||s.set(n,r=Xl()),cp(r,{effect:ht,target:t,type:e,key:n})}}function cp(t,e){let n=!1;kr<=$c?op(t)||(t.n|=Vn,n=!ip(t)):n=!t.has(ht),n&&(t.add(ht),ht.deps.push(t),ht.onTrack&&ht.onTrack(Object.assign({effect:ht},e)))}function fn(t,e,n,s,r,i){const o=Fc.get(t);if(!o)return;let a=[];if(e==="clear")a=[...o.values()];else if(n==="length"&&W(t)){const l=Number(s);o.forEach((u,h)=>{(h==="length"||h>=l)&&a.push(u)})}else switch(n!==void 0&&a.push(o.get(n)),e){case"add":W(t)?Ql(n)&&a.push(o.get("length")):(a.push(o.get(ds)),hs(t)&&a.push(o.get(Bc)));break;case"delete":W(t)||(a.push(o.get(ds)),hs(t)&&a.push(o.get(Bc)));break;case"set":hs(t)&&a.push(o.get(ds));break}const c={target:t,type:e,key:n,newValue:s,oldValue:r,oldTarget:i};if(a.length===1)a[0]&&Vc(a[0],c);else{const l=[];for(const u of a)u&&l.push(...u);Vc(Xl(l),c)}}function Vc(t,e){const n=W(t)?t:[...t];for(const s of n)s.computed&&Oh(s,e);for(const s of n)s.computed||Oh(s,e)}function Oh(t,e){(t!==ht||t.allowRecurse)&&(t.onTrigger&&t.onTrigger(Pe({effect:t},e)),t.scheduler?t.scheduler():t.run())}const v_=Gn("__proto__,__v_isRef,__isVue"),lp=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(Kl)),__=fa(),w_=fa(!1,!0),b_=fa(!0),E_=fa(!0,!0),Nh=T_();function T_(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const s=te(this);for(let i=0,o=this.length;i<o;i++)_t(s,"get",i+"");const r=s[e](...n);return r===-1||r===!1?s[e](...n.map(te)):r}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){Os();const s=te(this)[e].apply(this,n);return Ns(),s}}),t}function I_(t){const e=te(this);return _t(e,"has",t),e.hasOwnProperty(t)}function fa(t=!1,e=!1){return function(s,r,i){if(r==="__v_isReactive")return!t;if(r==="__v_isReadonly")return t;if(r==="__v_isShallow")return e;if(r==="__v_raw"&&i===(t?e?yp:mp:e?gp:pp).get(s))return s;const o=W(s);if(!t){if(o&&oe(Nh,r))return Reflect.get(Nh,r,i);if(r==="hasOwnProperty")return I_}const a=Reflect.get(s,r,i);return(Kl(r)?lp.has(r):v_(r))||(t||_t(s,"get",r),e)?a:Ve(a)?o&&Ql(r)?a:a.value:we(a)?t?vp(a):Ii(a):a}}const A_=up(),S_=up(!0);function up(t=!1){return function(n,s,r,i){let o=n[s];if(jn(o)&&Ve(o)&&!Ve(r))return!1;if(!t&&(!Lo(r)&&!jn(r)&&(o=te(o),r=te(r)),!W(n)&&Ve(o)&&!Ve(r)))return o.value=r,!0;const a=W(n)&&Ql(s)?Number(s)<n.length:oe(n,s),c=Reflect.set(n,s,r,i);return n===te(i)&&(a?Yr(r,o)&&fn(n,"set",s,r,o):fn(n,"add",s,r)),c}}function C_(t,e){const n=oe(t,e),s=t[e],r=Reflect.deleteProperty(t,e);return r&&n&&fn(t,"delete",e,void 0,s),r}function k_(t,e){const n=Reflect.has(t,e);return(!Kl(e)||!lp.has(e))&&_t(t,"has",e),n}function R_(t){return _t(t,"iterate",W(t)?"length":ds),Reflect.ownKeys(t)}const hp={get:__,set:A_,deleteProperty:C_,has:k_,ownKeys:R_},dp={get:b_,set(t,e){return Uc(`Set operation on key "${String(e)}" failed: target is readonly.`,t),!0},deleteProperty(t,e){return Uc(`Delete operation on key "${String(e)}" failed: target is readonly.`,t),!0}},O_=Pe({},hp,{get:w_,set:S_}),N_=Pe({},dp,{get:E_}),Jl=t=>t,pa=t=>Reflect.getPrototypeOf(t);function Zi(t,e,n=!1,s=!1){t=t.__v_raw;const r=te(t),i=te(e);n||(e!==i&&_t(r,"get",e),_t(r,"get",i));const{has:o}=pa(r),a=s?Jl:n?Zl:Jr;if(o.call(r,e))return a(t.get(e));if(o.call(r,i))return a(t.get(i));t!==r&&t.get(e)}function eo(t,e=!1){const n=this.__v_raw,s=te(n),r=te(t);return e||(t!==r&&_t(s,"has",t),_t(s,"has",r)),t===r?n.has(t):n.has(t)||n.has(r)}function to(t,e=!1){return t=t.__v_raw,!e&&_t(te(t),"iterate",ds),Reflect.get(t,"size",t)}function Ph(t){t=te(t);const e=te(this);return pa(e).has.call(e,t)||(e.add(t),fn(e,"add",t,t)),this}function Dh(t,e){e=te(e);const n=te(this),{has:s,get:r}=pa(n);let i=s.call(n,t);i?fp(n,s,t):(t=te(t),i=s.call(n,t));const o=r.call(n,t);return n.set(t,e),i?Yr(e,o)&&fn(n,"set",t,e,o):fn(n,"add",t,e),this}function xh(t){const e=te(this),{has:n,get:s}=pa(e);let r=n.call(e,t);r?fp(e,n,t):(t=te(t),r=n.call(e,t));const i=s?s.call(e,t):void 0,o=e.delete(t);return r&&fn(e,"delete",t,void 0,i),o}function Mh(){const t=te(this),e=t.size!==0,n=hs(t)?new Map(t):new Set(t),s=t.clear();return e&&fn(t,"clear",void 0,void 0,n),s}function no(t,e){return function(s,r){const i=this,o=i.__v_raw,a=te(o),c=e?Jl:t?Zl:Jr;return!t&&_t(a,"iterate",ds),o.forEach((l,u)=>s.call(r,c(l),c(u),i))}}function so(t,e,n){return function(...s){const r=this.__v_raw,i=te(r),o=hs(i),a=t==="entries"||t===Symbol.iterator&&o,c=t==="keys"&&o,l=r[t](...s),u=n?Jl:e?Zl:Jr;return!e&&_t(i,"iterate",c?Bc:ds),{next(){const{value:h,done:d}=l.next();return d?{value:h,done:d}:{value:a?[u(h[0]),u(h[1])]:u(h),done:d}},[Symbol.iterator](){return this}}}}function En(t){return function(...e){{const n=e[0]?`on key "${e[0]}" `:"";console.warn(`${Es(t)} operation ${n}failed: target is readonly.`,te(this))}return t==="delete"?!1:this}}function P_(){const t={get(i){return Zi(this,i)},get size(){return to(this)},has:eo,add:Ph,set:Dh,delete:xh,clear:Mh,forEach:no(!1,!1)},e={get(i){return Zi(this,i,!1,!0)},get size(){return to(this)},has:eo,add:Ph,set:Dh,delete:xh,clear:Mh,forEach:no(!1,!0)},n={get(i){return Zi(this,i,!0)},get size(){return to(this,!0)},has(i){return eo.call(this,i,!0)},add:En("add"),set:En("set"),delete:En("delete"),clear:En("clear"),forEach:no(!0,!1)},s={get(i){return Zi(this,i,!0,!0)},get size(){return to(this,!0)},has(i){return eo.call(this,i,!0)},add:En("add"),set:En("set"),delete:En("delete"),clear:En("clear"),forEach:no(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(i=>{t[i]=so(i,!1,!1),n[i]=so(i,!0,!1),e[i]=so(i,!1,!0),s[i]=so(i,!0,!0)}),[t,n,e,s]}const[D_,x_,M_,L_]=P_();function ga(t,e){const n=e?t?L_:M_:t?x_:D_;return(s,r,i)=>r==="__v_isReactive"?!t:r==="__v_isReadonly"?t:r==="__v_raw"?s:Reflect.get(oe(n,r)&&r in s?n:s,r,i)}const U_={get:ga(!1,!1)},F_={get:ga(!1,!0)},$_={get:ga(!0,!1)},B_={get:ga(!0,!0)};function fp(t,e,n){const s=te(n);if(s!==n&&e.call(t,s)){const r=Gl(t);console.warn(`Reactive ${r} contains both the raw and reactive versions of the same object${r==="Map"?" as keys":""}, which can lead to inconsistencies. Avoid differentiating between the raw and reactive versions of an object and only use the reactive version if possible.`)}}const pp=new WeakMap,gp=new WeakMap,mp=new WeakMap,yp=new WeakMap;function V_(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function j_(t){return t.__v_skip||!Object.isExtensible(t)?0:V_(Gl(t))}function Ii(t){return jn(t)?t:ma(t,!1,hp,U_,pp)}function H_(t){return ma(t,!1,O_,F_,gp)}function vp(t){return ma(t,!0,dp,$_,mp)}function Ws(t){return ma(t,!0,N_,B_,yp)}function ma(t,e,n,s,r){if(!we(t))return console.warn(`value cannot be made reactive: ${String(t)}`),t;if(t.__v_raw&&!(e&&t.__v_isReactive))return t;const i=r.get(t);if(i)return i;const o=j_(t);if(o===0)return t;const a=new Proxy(t,o===2?s:n);return r.set(t,a),a}function fs(t){return jn(t)?fs(t.__v_raw):!!(t&&t.__v_isReactive)}function jn(t){return!!(t&&t.__v_isReadonly)}function Lo(t){return!!(t&&t.__v_isShallow)}function jc(t){return fs(t)||jn(t)}function te(t){const e=t&&t.__v_raw;return e?te(e):t}function _p(t){return Mo(t,"__v_skip",!0),t}const Jr=t=>we(t)?Ii(t):t,Zl=t=>we(t)?vp(t):t;function wp(t){Mn&&ht&&(t=te(t),cp(t.dep||(t.dep=Xl()),{target:t,type:"get",key:"value"}))}function bp(t,e){t=te(t);const n=t.dep;n&&Vc(n,{target:t,type:"set",key:"value",newValue:e})}function Ve(t){return!!(t&&t.__v_isRef===!0)}function q_(t){return Ep(t,!1)}function z_(t){return Ep(t,!0)}function Ep(t,e){return Ve(t)?t:new K_(t,e)}class K_{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:te(e),this._value=n?e:Jr(e)}get value(){return wp(this),this._value}set value(e){const n=this.__v_isShallow||Lo(e)||jn(e);e=n?e:te(e),Yr(e,this._rawValue)&&(this._rawValue=e,this._value=n?e:Jr(e),bp(this,e))}}function Ys(t){return Ve(t)?t.value:t}const W_={get:(t,e,n)=>Ys(Reflect.get(t,e,n)),set:(t,e,n,s)=>{const r=t[e];return Ve(r)&&!Ve(n)?(r.value=n,!0):Reflect.set(t,e,n,s)}};function Tp(t){return fs(t)?t:new Proxy(t,W_)}var Ip;class G_{constructor(e,n,s,r){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this[Ip]=!1,this._dirty=!0,this.effect=new Yl(e,()=>{this._dirty||(this._dirty=!0,bp(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!r,this.__v_isReadonly=s}get value(){const e=te(this);return wp(e),(e._dirty||!e._cacheable)&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}Ip="__v_isReadonly";function Q_(t,e,n=!1){let s,r;const i=Q(t);i?(s=t,r=()=>{console.warn("Write operation failed: computed value is readonly")}):(s=t.get,r=t.set);const o=new G_(s,r,i||!r,n);return e&&!n&&(o.effect.onTrack=e.onTrack,o.effect.onTrigger=e.onTrigger),o}const ps=[];function wo(t){ps.push(t)}function bo(){ps.pop()}function k(t,...e){Os();const n=ps.length?ps[ps.length-1].component:null,s=n&&n.appContext.config.warnHandler,r=X_();if(s)un(s,n,11,[t+e.join(""),n&&n.proxy,r.map(({vnode:i})=>`at <${Ta(n,i.type)}>`).join(`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class XE{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(YE(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function YE(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const cl="@firebase/app",dd="0.9.7";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fr=ET;function wg(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:ll,automaticDataCollectionEnabled:!1},e),r=s.name;if(typeof r!="string"||!r)throw Un.create("bad-app-name",{appName:String(r)});if(n||(n=gE()),!n)throw Un.create("no-options");const i=Ho.get(r);if(i){if(jo(n,i.options)&&jo(s,i.config))return i;throw Un.create("duplicate-app",{appName:r})}const o=new xE(r);for(const c of ul.values())o.addComponent(c);const a=new ST(n,s,o);return Ho.set(r,a),a}function Aa(t=ll){const e=Ho.get(t);if(!e&&t===ll)return wg();if(!e)throw Un.create("no-app",{appName:t});return e}function kt(t,e,n){var s;let r=(s=TT[t])!==null&&s!==void 0?s:t;n&&(r+=`-${n}`);const i=r.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const a=[`Unable to register library "${r}" with version "${e}":`];i&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),i&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Is.warn(a.join(" "));return}Hn(new pn(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const CT="firebase-heartbeat-database",kT=1,ri="firebase-heartbeat-store";let gc=null;function bg(){return gc||(gc=WE(CT,kT,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(ri)}}}).catch(t=>{throw Un.create("idb-open",{originalErrorMessage:t.message})})),gc}async function RT(t){try{return(await bg()).transaction(ri).objectStore(ri).get(Eg(t))}catch(e){if(e instanceof en)Is.warn(e.message);else{const n=Un.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Is.warn(n.message)}}}async function fd(t,e){try{const s=(await bg()).transaction(ri,"readwrite");return await s.objectStore(ri).put(e,Eg(t)),s.done}catch(n){if(n instanceof en)Is.warn(n.message);else{const s=Un.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Is.warn(s.message)}}}function Eg(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const OT=1024,NT=30*24*60*60*1e3;class PT{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new xT(n),this._heartbeatsCachePromise=this._storage.read().then(s=>(this._heartbeatsCache=s,s))}async triggerHeartbeat(){const n=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=pd();if(this._heartbeatsCache===null&&(this._heartbeatsCache=await this._heartbeatsCachePromise),!(this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(r=>r.date===s)))return this._heartbeatsCache.heartbeats.push({date:s,agent:n}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(r=>{const i=new Date(r.date).valueOf();return Date.now()-i<=NT}),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache===null||this._heartbeatsCache.heartbeats.length===0)return"";const e=pd(),{heartbeatsToSend:n,unsentEntries:s}=DT(this._heartbeatsCache.heartbeats),r=Vo(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=e,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}}function pd(){return new Date().toISOString().substring(0,10)}function DT(t,e=OT){const n=[];let s=t.slice();for(const r of t){const i=n.find(o=>o.agent===r.agent);if(i){if(i.dates.push(r.date),gd(n)>e){i.dates.pop();break}}else if(n.push({agent:r.agent,dates:[r.date]}),gd(n)>e){n.pop();break}s=s.slice(1)}return{heartbeatsToSend:n,unsentEntries:s}}class xT{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return EE()?TE().then(()=>!0).catch(()=>!1):!1}async read(){return await this._canUseIndexedDBPromise?await RT(this.app)||{heartbeats:[]}:{heartbeats:[]}}async overwrite(e){var n;if(await this._canUseIndexedDBPromise){const r=await this.read();return fd(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:r.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var n;if(await this._canUseIndexedDBPromise){const r=await this.read();return fd(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...e.heartbeats]})}else return}}function gd(t){return Vo(JSON.stringify({version:2,heartbeats:t})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function MT(t){Hn(new pn("platform-logger",e=>new XE(e),"PRIVATE")),Hn(new pn("heartbeat",e=>new PT(e),"PRIVATE")),kt(cl,dd,t),kt(cl,dd,"esm2017"),kt("fire-js","")}MT("");var LT=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},$,gu=gu||{},Y=LT||self;function qo(){}function Sa(t){var e=typeof t;return e=e!="object"?e:t?Array.isArray(t)?"array":e:"null",e=="array"||e=="object"&&typeof t.length=="number"}function Ni(t){var e=typeof t;return e=="object"&&t!=null||e=="function"}function UT(t){return Object.prototype.hasOwnProperty.call(t,mc)&&t[mc]||(t[mc]=++FT)}var mc="closure_uid_"+(1e9*Math.random()>>>0),FT=0;function $T(t,e,n){return t.call.apply(t.bind,arguments)}function BT(t,e,n){if(!t)throw Error();if(2<arguments.length){var s=Array.prototype.slice.call(arguments,2);return function(){var r=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(r,s),t.apply(e,r)}}return function(){return t.apply(e,arguments)}}function rt(t,e,n){return Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?rt=$T:rt=BT,rt.apply(null,arguments)}function io(t,e){var n=Array.prototype.slice.call(arguments,1);return function(){var s=n.slice();return s.push.apply(s,arguments),t.apply(this,s)}}function Je(t,e){function n(){}n.prototype=e.prototype,t.X=e.prototype,t.prototype=new n,t.prototype.constructor=t,t.Wb=function(s,r,i){for(var o=Array(arguments.length-2),a=2;a<arguments.length;a++)o[a-2]=arguments[a];return e.prototype[r].apply(s,o)}}function Qn(){this.s=this.s,this.o=this.o}var VT=0;Qn.prototype.s=!1;Qn.prototype.na=function(){!this.s&&(this.s=!0,this.M(),VT!=0)&&UT(this)};Qn.prototype.M=function(){if(this.o)for(;this.o.length;)this.o.shift()()};const Tg=Array.prototype.indexOf?function(t,e){return Array.prototype.indexOf.call(t,e,void 0)}:function(t,e){if(typeof t=="string")return typeof e!="string"||e.length!=1?-1:t.indexOf(e,0);for(let n=0;n<t.length;n++)if(n in t&&t[n]===e)return n;return-1};function mu(t){const e=t.length;if(0<e){const n=Array(e);for(let s=0;s<e;s++)n[s]=t[s];return n}return[]}function md(t,e){for(let n=1;n<arguments.length;n++){const s=arguments[n];if(Sa(s)){const r=t.length||0,i=s.length||0;t.length=r+i;for(let o=0;o<i;o++)t[r+o]=s[o]}else t.push(s)}}function it(t,e){this.type=t,this.g=this.target=e,this.defaultPrevented=!1}it.prototype.h=function(){this.defaultPrevented=!0};var jT=function(){if(!Y.addEventListener||!Object.defineProperty)return!1;var t=!1,e=Object.defineProperty({},"passive",{get:function(){t=!0}});try{Y.addEventListener("test",qo,e),Y.removeEventListener("test",qo,e)}catch{}return t}();function zo(t){return/^[\s\xa0]*$/.test(t)}var yd=String.prototype.trim?function(t){return t.trim()}:function(t){return/^[\s\xa0]*([\s\S]*?)[\s\xa0]*$/.exec(t)[1]};function yc(t,e){return t<e?-1:t>e?1:0}function Ca(){var t=Y.navigator;return t&&(t=t.userAgent)?t:""}function qt(t){return Ca().indexOf(t)!=-1}function yu(t){return yu[" "](t),t}yu[" "]=qo;function HT(t){var e=KT;return Object.prototype.hasOwnProperty.call(e,9)?e[9]:e[9]=t(9)}var qT=qt("Opera"),rr=qt("Trident")||qt("MSIE"),Ig=qt("Edge"),hl=Ig||rr,Ag=qt("Gecko")&&!(Ca().toLowerCase().indexOf("webkit")!=-1&&!qt("Edge"))&&!(qt("Trident")||qt("MSIE"))&&!qt("Edge"),zT=Ca().toLowerCase().indexOf("webkit")!=-1&&!qt("Edge");function Sg(){var t=Y.document;return t?t.documentMode:void 0}var Ko;e:{var vc="",_c=function(){var t=Ca();if(Ag)return/rv:([^\);]+)(\)|;)/.exec(t);if(Ig)return/Edge\/([\d\.]+)/.exec(t);if(rr)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(t);if(zT)return/WebKit\/(\S+)/.exec(t);if(qT)return/(?:Version)[ \/]?(\S+)/.exec(t)}();if(_c&&(vc=_c?_c[1]:""),rr){var wc=Sg();if(wc!=null&&wc>parseFloat(vc)){Ko=String(wc);break e}}Ko=vc}var KT={};function WT(){return HT(function(){let t=0;const e=yd(String(Ko)).split("."),n=yd("9").split("."),s=Math.max(e.length,n.length);for(let o=0;t==0&&o<s;o++){var r=e[o]||"",i=n[o]||"";do{if(r=/(\d*)(\D*)(.*)/.exec(r)||["","","",""],i=/(\d*)(\D*)(.*)/.exec(i)||["","","",""],r[0].length==0&&i[0].length==0)break;t=yc(r[1].length==0?0:parseInt(r[1],10),i[1].length==0?0:parseInt(i[1],10))||yc(r[2].length==0,i[2].length==0)||yc(r[2],i[2]),r=r[3],i=i[3]}while(t==0)}return 0<=t})}var dl;if(Y.document&&rr){var vd=Sg();dl=vd||parseInt(Ko,10)||void 0}else dl=void 0;var GT=dl;function ii(t,e){if(it.call(this,t?t.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,t){var n=this.type=t.type,s=t.changedTouches&&t.changedTouches.length?t.changedTouches[0]:null;if(this.target=t.target||t.srcElement,this.g=e,e=t.relatedTarget){if(Ag){e:{try{yu(e.nodeName);var r=!0;break e}catch{}r=!1}r||(e=null)}}else n=="mouseover"?e=t.fromElement:n=="mouseout"&&(e=t.toElement);this.relatedTarget=e,s?(this.clientX=s.clientX!==void 0?s.clientX:s.pageX,this.clientY=s.clientY!==void 0?s.clientY:s.pageY,this.screenX=s.screenX||0,this.screenY=s.screenY||0):(this.clientX=t.clientX!==void 0?t.clientX:t.pageX,this.clientY=t.clientY!==void 0?t.clientY:t.pageY,this.screenX=t.screenX||0,this.screenY=t.screenY||0),this.button=t.button,this.key=t.key||"",this.ctrlKey=t.ctrlKey,this.altKey=t.altKey,this.shiftKey=t.shiftKey,this.metaKey=t.metaKey,this.pointerId=t.pointerId||0,this.pointerType=typeof t.pointerType=="string"?t.pointerType:QT[t.pointerType]||"",this.state=t.state,this.i=t,t.defaultPrevented&&ii.X.h.call(this)}}Je(ii,it);var QT={2:"touch",3:"pen",4:"mouse"};ii.prototype.h=function(){ii.X.h.call(this);var t=this.i;t.preventDefault?t.preventDefault():t.returnValue=!1};var Pi="closure_listenable_"+(1e6*Math.random()|0),XT=0;function YT(t,e,n,s,r){this.listener=t,this.proxy=null,this.src=e,this.type=n,this.capture=!!s,this.ha=r,this.key=++XT,this.ba=this.ea=!1}function ka(t){t.ba=!0,t.listener=null,t.proxy=null,t.src=null,t.ha=null}function vu(t,e,n){for(const s in t)e.call(n,t[s],s,t)}function Cg(t){const e={};for(const n in t)e[n]=t[n];return e}const _d="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function kg(t,e){let n,s;for(let r=1;r<arguments.length;r++){s=arguments[r];for(n in s)t[n]=s[n];for(let i=0;i<_d.length;i++)n=_d[i],Object.prototype.hasOwnProperty.call(s,n)&&(t[n]=s[n])}}function Ra(t){this.src=t,this.g={},this.h=0}Ra.prototype.add=function(t,e,n,s,r){var i=t.toString();t=this.g[i],t||(t=this.g[i]=[],this.h++);var o=pl(t,e,s,r);return-1<o?(e=t[o],n||(e.ea=!1)):(e=new YT(e,this.src,i,!!s,r),e.ea=n,t.push(e)),e};function fl(t,e){var n=e.type;if(n in t.g){var s=t.g[n],r=Tg(s,e),i;(i=0<=r)&&Array.prototype.splice.call(s,r,1),i&&(ka(e),t.g[n].length==0&&(delete t.g[n],t.h--))}}function pl(t,e,n,s){for(var r=0;r<t.length;++r){var i=t[r];if(!i.ba&&i.listener==e&&i.capture==!!n&&i.ha==s)return r}return-1}var _u="closure_lm_"+(1e6*Math.random()|0),bc={};function Rg(t,e,n,s,r){if(s&&s.once)return Ng(t,e,n,s,r);if(Array.isArray(e)){for(var i=0;i<e.length;i++)Rg(t,e[i],n,s,r);return null}return n=Eu(n),t&&t[Pi]?t.N(e,n,Ni(s)?!!s.capture:!!s,r):Og(t,e,n,!1,s,r)}function Og(t,e,n,s,r,i){if(!e)throw Error("Invalid event type");var o=Ni(r)?!!r.capture:!!r,a=bu(t);if(a||(t[_u]=a=new Ra(t)),n=a.add(e,n,s,o,i),n.proxy)return n;if(s=JT(),n.proxy=s,s.src=t,s.listener=n,t.addEventListener)jT||(r=o),r===void 0&&(r=!1),t.addEventListener(e.toString(),s,r);else if(t.attachEvent)t.attachEvent(Dg(e.toString()),s);else if(t.addListener&&t.removeListener)t.addListener(s);else throw Error("addEventListener and attachEvent are unavailable.");return n}function JT(){function t(n){return e.call(t.src,t.listener,n)}const e=ZT;return t}function Ng(t,e,n,s,r){if(Array.isArray(e)){for(var i=0;i<e.length;i++)Ng(t,e[i],n,s,r);return null}return n=Eu(n),t&&t[Pi]?t.O(e,n,Ni(s)?!!s.capture:!!s,r):Og(t,e,n,!0,s,r)}function Pg(t,e,n,s,r){if(Array.isArray(e))for(var i=0;i<e.length;i++)Pg(t,e[i],n,s,r);else s=Ni(s)?!!s.capture:!!s,n=Eu(n),t&&t[Pi]?(t=t.i,e=String(e).toString(),e in t.g&&(i=t.g[e],n=pl(i,n,s,r),-1<n&&(ka(i[n]),Array.prototype.splice.call(i,n,1),i.length==0&&(delete t.g[e],t.h--)))):t&&(t=bu(t))&&(e=t.g[e.toString()],t=-1,e&&(t=pl(e,n,s,r)),(n=-1<t?e[t]:null)&&wu(n))}function wu(t){if(typeof t!="number"&&t&&!t.ba){var e=t.src;if(e&&e[Pi])fl(e.i,t);else{var n=t.type,s=t.proxy;e.removeEventListener?e.removeEventListener(n,s,t.capture):e.detachEvent?e.detachEvent(Dg(n),s):e.addListener&&e.removeListener&&e.removeListener(s),(n=bu(e))?(fl(n,t),n.h==0&&(n.src=null,e[_u]=null)):ka(t)}}}function Dg(t){return t in bc?bc[t]:bc[t]="on"+t}function ZT(t,e){if(t.ba)t=!0;else{e=new ii(e,this);var n=t.listener,s=t.ha||t.src;t.ea&&wu(t),t=n.call(s,e)}return t}function bu(t){return t=t[_u],t instanceof Ra?t:null}var Ec="__closure_events_fn_"+(1e9*Math.random()>>>0);function Eu(t){return typeof t=="function"?t:(t[Ec]||(t[Ec]=function(e){return t.handleEvent(e)}),t[Ec])}function Ge(){Qn.call(this),this.i=new Ra(this),this.P=this,this.I=null}Je(Ge,Qn);Ge.prototype[Pi]=!0;Ge.prototype.removeEventListener=function(t,e,n,s){Pg(this,t,e,n,s)};function Ye(t,e){var n,s=t.I;if(s)for(n=[];s;s=s.I)n.push(s);if(t=t.P,s=e.type||e,typeof e=="string")e=new it(e,t);else if(e instanceof it)e.target=e.target||t;else{var r=e;e=new it(s,t),kg(e,r)}if(r=!0,n)for(var i=n.length-1;0<=i;i--){var o=e.g=n[i];r=oo(o,s,!0,e)&&r}if(o=e.g=t,r=oo(o,s,!0,e)&&r,r=oo(o,s,!1,e)&&r,n)for(i=0;i<n.length;i++)o=e.g=n[i],r=oo(o,s,!1,e)&&r}Ge.prototype.M=function(){if(Ge.X.M.call(this),this.i){var t=this.i,e;for(e in t.g){for(var n=t.g[e],s=0;s<n.length;s++)ka(n[s]);delete t.g[e],t.h--}}this.I=null};Ge.prototype.N=function(t,e,n,s){return this.i.add(String(t),e,!1,n,s)};Ge.prototype.O=function(t,e,n,s){return this.i.add(String(t),e,!0,n,s)};function oo(t,e,n,s){if(e=t.i.g[String(e)],!e)return!0;e=e.concat();for(var r=!0,i=0;i<e.length;++i){var o=e[i];if(o&&!o.ba&&o.capture==n){var a=o.listener,c=o.ha||o.src;o.ea&&fl(t.i,o),r=a.call(c,s)!==!1&&r}}return r&&!s.defaultPrevented}var Tu=Y.JSON.stringify;function eI(){var t=Lg;let e=null;return t.g&&(e=t.g,t.g=t.g.next,t.g||(t.h=null),e.next=null),e}class tI{constructor(){this.h=this.g=null}add(e,n){const s=xg.get();s.set(e,n),this.h?this.h.next=s:this.g=s,this.h=s}}var xg=new class{constructor(t,e){this.i=t,this.j=e,this.h=0,this.g=null}get(){let t;return 0<this.h?(this.h--,t=this.g,this.g=t.next,t.next=null):t=this.i(),t}}(()=>new nI,t=>t.reset());class nI{constructor(){this.next=this.g=this.h=null}set(e,n){this.h=e,this.g=n,this.next=null}reset(){this.next=this.g=this.h=null}}function sI(t){Y.setTimeout(()=>{throw t},0)}function Mg(t,e){gl||rI(),ml||(gl(),ml=!0),Lg.add(t,e)}var gl;function rI(){var t=Y.Promise.resolve(void 0);gl=function(){t.then(iI)}}var ml=!1,Lg=new tI;function iI(){for(var t;t=eI();){try{t.h.call(t.g)}catch(n){sI(n)}var e=xg;e.j(t),100>e.h&&(e.h++,t.next=e.g,e.g=t)}ml=!1}function Oa(t,e){Ge.call(this),this.h=t||1,this.g=e||Y,this.j=rt(this.lb,this),this.l=Date.now()}Je(Oa,Ge);$=Oa.prototype;$.ca=!1;$.R=null;$.lb=function(){if(this.ca){var t=Date.now()-this.l;0<t&&t<.8*this.h?this.R=this.g.setTimeout(this.j,this.h-t):(this.R&&(this.g.clearTimeout(this.R),this.R=null),Ye(this,"tick"),this.ca&&(Iu(this),this.start()))}};$.start=function(){this.ca=!0,this.R||(this.R=this.g.setTimeout(this.j,this.h),this.l=Date.now())};function Iu(t){t.ca=!1,t.R&&(t.g.clearTimeout(t.R),t.R=null)}$.M=function(){Oa.X.M.call(this),Iu(this),delete this.g};function Au(t,e,n){if(typeof t=="function")n&&(t=rt(t,n));else if(t&&typeof t.handleEvent=="function")t=rt(t.handleEvent,t);else throw Error("Invalid listener argument");return 2147483647<Number(e)?-1:Y.setTimeout(t,e||0)}function Ug(t){t.g=Au(()=>{t.g=null,t.i&&(t.i=!1,Ug(t))},t.j);const e=t.h;t.h=null,t.m.apply(null,e)}class oI extends Qn{constructor(e,n){super(),this.m=e,this.j=n,this.h=null,this.i=!1,this.g=null}l(e){this.h=arguments,this.g?this.i=!0:Ug(this)}M(){super.M(),this.g&&(Y.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function oi(t){Qn.call(this),this.h=t,this.g={}}Je(oi,Qn);var wd=[];function Fg(t,e,n,s){Array.isArray(n)||(n&&(wd[0]=n.toString()),n=wd);for(var r=0;r<n.length;r++){var i=Rg(e,n[r],s||t.handleEvent,!1,t.h||t);if(!i)break;t.g[i.key]=i}}function $g(t){vu(t.g,function(e,n){this.g.hasOwnProperty(n)&&wu(e)},t),t.g={}}oi.prototype.M=function(){oi.X.M.call(this),$g(this)};oi.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};function Na(){this.g=!0}Na.prototype.Aa=function(){this.g=!1};function aI(t,e,n,s,r,i){t.info(function(){if(t.g)if(i)for(var o="",a=i.split("&"),c=0;c<a.length;c++){var l=a[c].split("=");if(1<l.length){var u=l[0];l=l[1];var h=u.split("_");o=2<=h.length&&h[1]=="type"?o+(u+"="+l+"&"):o+(u+"=redacted&")}}else o=null;else o=i;return"XMLHTTP REQ ("+s+") [attempt "+r+"]: "+e+`
`+n+`
`+o})}function cI(t,e,n,s,r,i,o){t.info(function(){return"XMLHTTP RESP ("+s+") [ attempt "+r+"]: "+e+`
`+n+`
`+i+" "+o})}function Gs(t,e,n,s){t.info(function(){return"XMLHTTP TEXT ("+e+"): "+uI(t,n)+(s?" "+s:"")})}function lI(t,e){t.info(function(){return"TIMEOUT: "+e})}Na.prototype.info=function(){};function uI(t,e){if(!t.g)return e;if(!e)return null;try{var n=JSON.parse(e);if(n){for(t=0;t<n.length;t++)if(Array.isArray(n[t])){var s=n[t];if(!(2>s.length)){var r=s[1];if(Array.isArray(r)&&!(1>r.length)){var i=r[0];if(i!="noop"&&i!="stop"&&i!="close")for(var o=1;o<r.length;o++)r[o]=""}}}}return Tu(n)}catch{return e}}var Ps={},bd=null;function Pa(){return bd=bd||new Ge}Ps.Pa="serverreachability";function Bg(t){it.call(this,Ps.Pa,t)}Je(Bg,it);function ai(t){const e=Pa();Ye(e,new Bg(e))}Ps.STAT_EVENT="statevent";function Vg(t,e){it.call(this,Ps.STAT_EVENT,t),this.stat=e}Je(Vg,it);function ft(t){const e=Pa();Ye(e,new Vg(e,t))}Ps.Qa="timingevent";function jg(t,e){it.call(this,Ps.Qa,t),this.size=e}Je(jg,it);function Di(t,e){if(typeof t!="function")throw Error("Fn must not be null and must be a function");return Y.setTimeout(function(){t()},e)}var Da={NO_ERROR:0,mb:1,zb:2,yb:3,tb:4,xb:5,Ab:6,Ma:7,TIMEOUT:8,Db:9},Hg={rb:"complete",Nb:"success",Na:"error",Ma:"abort",Fb:"ready",Gb:"readystatechange",TIMEOUT:"timeout",Bb:"incrementaldata",Eb:"progress",ub:"downloadprogress",Vb:"uploadprogress"};function Su(){}Su.prototype.h=null;function Ed(t){return t.h||(t.h=t.i())}function qg(){}var xi={OPEN:"a",qb:"b",Na:"c",Cb:"d"};function Cu(){it.call(this,"d")}Je(Cu,it);function ku(){it.call(this,"c")}Je(ku,it);var yl;function xa(){}Je(xa,Su);xa.prototype.g=function(){return new XMLHttpRequest};xa.prototype.i=function(){return{}};yl=new xa;function Mi(t,e,n,s){this.l=t,this.j=e,this.m=n,this.U=s||1,this.S=new oi(this),this.O=hI,t=hl?125:void 0,this.T=new Oa(t),this.H=null,this.i=!1,this.s=this.A=this.v=this.K=this.F=this.V=this.B=null,this.D=[],this.g=null,this.C=0,this.o=this.u=null,this.Y=-1,this.I=!1,this.N=0,this.L=null,this.$=this.J=this.Z=this.P=!1,this.h=new zg}function zg(){this.i=null,this.g="",this.h=!1}var hI=45e3,vl={},Wo={};$=Mi.prototype;$.setTimeout=function(t){this.O=t};function _l(t,e,n){t.K=1,t.v=La(gn(e)),t.s=n,t.P=!0,Kg(t,null)}function Kg(t,e){t.F=Date.now(),Li(t),t.A=gn(t.v);var n=t.A,s=t.U;Array.isArray(s)||(s=[String(s)]),em(n.i,"t",s),t.C=0,n=t.l.H,t.h=new zg,t.g=bm(t.l,n?e:null,!t.s),0<t.N&&(t.L=new oI(rt(t.La,t,t.g),t.N)),Fg(t.S,t.g,"readystatechange",t.ib),e=t.H?Cg(t.H):{},t.s?(t.u||(t.u="POST"),e["Content-Type"]="application/x-www-form-urlencoded",t.g.da(t.A,t.u,t.s,e)):(t.u="GET",t.g.da(t.A,t.u,null,e)),ai(),aI(t.j,t.u,t.A,t.m,t.U,t.s)}$.ib=function(t){t=t.target;const e=this.L;e&&an(t)==3?e.l():this.La(t)};$.La=function(t){try{if(t==this.g)e:{const u=an(this.g);var e=this.g.Ea();const h=this.g.aa();if(!(3>u)&&(u!=3||hl||this.g&&(this.h.h||this.g.fa()||Sd(this.g)))){this.I||u!=4||e==7||(e==8||0>=h?ai(3):ai(2)),Ma(this);var n=this.g.aa();this.Y=n;t:if(Wg(this)){var s=Sd(this.g);t="";var r=s.length,i=an(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){cs(this),jr(this);var o="";break t}this.h.i=new Y.TextDecoder}for(e=0;e<r;e++)this.h.h=!0,t+=this.h.i.decode(s[e],{stream:i&&e==r-1});s.splice(0,r),this.h.g+=t,this.C=0,o=this.h.g}else o=this.g.fa();if(this.i=n==200,cI(this.j,this.u,this.A,this.m,this.U,u,n),this.i){if(this.Z&&!this.J){t:{if(this.g){var a,c=this.g;if((a=c.g?c.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!zo(a)){var l=a;break t}}l=null}if(n=l)Gs(this.j,this.m,n,"Initial handshake response via X-HTTP-Initial-Response"),this.J=!0,wl(this,n);else{this.i=!1,this.o=3,ft(12),cs(this),jr(this);break e}}this.P?(Gg(this,u,o),hl&&this.i&&u==3&&(Fg(this.S,this.T,"tick",this.hb),this.T.start())):(Gs(this.j,this.m,o,null),wl(this,o)),u==4&&cs(this),this.i&&!this.I&&(u==4?ym(this.l,this):(this.i=!1,Li(this)))}else n==400&&0<o.indexOf("Unknown SID")?(this.o=3,ft(12)):(this.o=0,ft(13)),cs(this),jr(this)}}}catch{}finally{}};function Wg(t){return t.g?t.u=="GET"&&t.K!=2&&t.l.Da:!1}function Gg(t,e,n){let s=!0,r;for(;!t.I&&t.C<n.length;)if(r=dI(t,n),r==Wo){e==4&&(t.o=4,ft(14),s=!1),Gs(t.j,t.m,null,"[Incomplete Response]");break}else if(r==vl){t.o=4,ft(15),Gs(t.j,t.m,n,"[Invalid Chunk]"),s=!1;break}else Gs(t.j,t.m,r,null),wl(t,r);Wg(t)&&r!=Wo&&r!=vl&&(t.h.g="",t.C=0),e!=4||n.length!=0||t.h.h||(t.o=1,ft(16),s=!1),t.i=t.i&&s,s?0<n.length&&!t.$&&(t.$=!0,e=t.l,e.g==t&&e.$&&!e.K&&(e.j.info("Great, no buffering proxy detected. Bytes received: "+n.length),Mu(e),e.K=!0,ft(11))):(Gs(t.j,t.m,n,"[Invalid Chunked Response]"),cs(t),jr(t))}$.hb=function(){if(this.g){var t=an(this.g),e=this.g.fa();this.C<e.length&&(Ma(this),Gg(this,t,e),this.i&&t!=4&&Li(this))}};function dI(t,e){var n=t.C,s=e.indexOf(`
`,n);return s==-1?Wo:(n=Number(e.substring(n,s)),isNaN(n)?vl:(s+=1,s+n>e.length?Wo:(e=e.substr(s,n),t.C=s+n,e)))}$.cancel=function(){this.I=!0,cs(this)};function Li(t){t.V=Date.now()+t.O,Qg(t,t.O)}function Qg(t,e){if(t.B!=null)throw Error("WatchDog timer not null");t.B=Di(rt(t.gb,t),e)}function Ma(t){t.B&&(Y.clearTimeout(t.B),t.B=null)}$.gb=function(){this.B=null;const t=Date.now();0<=t-this.V?(lI(this.j,this.A),this.K!=2&&(ai(),ft(17)),cs(this),this.o=2,jr(this)):Qg(this,this.V-t)};function jr(t){t.l.G==0||t.I||ym(t.l,t)}function cs(t){Ma(t);var e=t.L;e&&typeof e.na=="function"&&e.na(),t.L=null,Iu(t.T),$g(t.S),t.g&&(e=t.g,t.g=null,e.abort(),e.na())}function wl(t,e){try{var n=t.l;if(n.G!=0&&(n.g==t||bl(n.h,t))){if(!t.J&&bl(n.h,t)&&n.G==3){try{var s=n.Fa.g.parse(e)}catch{s=null}if(Array.isArray(s)&&s.length==3){var r=s;if(r[0]==0){e:if(!n.u){if(n.g)if(n.g.F+3e3<t.F)Xo(n),$a(n);else break e;xu(n),ft(18)}}else n.Ba=r[1],0<n.Ba-n.T&&37500>r[2]&&n.L&&n.A==0&&!n.v&&(n.v=Di(rt(n.cb,n),6e3));if(1>=sm(n.h)&&n.ja){try{n.ja()}catch{}n.ja=void 0}}else ls(n,11)}else if((t.J||n.g==t)&&Xo(n),!zo(e))for(r=n.Fa.g.parse(e),e=0;e<r.length;e++){let l=r[e];if(n.T=l[0],l=l[1],n.G==2)if(l[0]=="c"){n.I=l[1],n.ka=l[2];const u=l[3];u!=null&&(n.ma=u,n.j.info("VER="+n.ma));const h=l[4];h!=null&&(n.Ca=h,n.j.info("SVER="+n.Ca));const d=l[5];d!=null&&typeof d=="number"&&0<d&&(s=1.5*d,n.J=s,n.j.info("backChannelRequestTimeoutMs_="+s)),s=n;const p=t.g;if(p){const m=p.g?p.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(m){var i=s.h;i.g||m.indexOf("spdy")==-1&&m.indexOf("quic")==-1&&m.indexOf("h2")==-1||(i.j=i.l,i.g=new Set,i.h&&(Ru(i,i.h),i.h=null))}if(s.D){const v=p.g?p.g.getResponseHeader("X-HTTP-Session-Id"):null;v&&(s.za=v,Se(s.F,s.D,v))}}n.G=3,n.l&&n.l.xa(),n.$&&(n.P=Date.now()-t.F,n.j.info("Handshake RTT: "+n.P+"ms")),s=n;var o=t;if(s.sa=wm(s,s.H?s.ka:null,s.V),o.J){rm(s.h,o);var a=o,c=s.J;c&&a.setTimeout(c),a.B&&(Ma(a),Li(a)),s.g=o}else gm(s);0<n.i.length&&Ba(n)}else l[0]!="stop"&&l[0]!="close"||ls(n,7);else n.G==3&&(l[0]=="stop"||l[0]=="close"?l[0]=="stop"?ls(n,7):Du(n):l[0]!="noop"&&n.l&&n.l.wa(l),n.A=0)}}ai(4)}catch{}}function fI(t){if(t.W&&typeof t.W=="function")return t.W();if(typeof Map<"u"&&t instanceof Map||typeof Set<"u"&&t instanceof Set)return Array.from(t.values());if(typeof t=="string")return t.split("");if(Sa(t)){for(var e=[],n=t.length,s=0;s<n;s++)e.push(t[s]);return e}e=[],n=0;for(s in t)e[n++]=t[s];return e}function pI(t){if(t.oa&&typeof t.oa=="function")return t.oa();if(!t.W||typeof t.W!="function"){if(typeof Map<"u"&&t instanceof Map)return Array.from(t.keys());if(!(typeof Set<"u"&&t instanceof Set)){if(Sa(t)||typeof t=="string"){var e=[];t=t.length;for(var n=0;n<t;n++)e.push(n);return e}e=[],n=0;for(const s in t)e[n++]=s;return e}}}function Xg(t,e){if(t.forEach&&typeof t.forEach=="function")t.forEach(e,void 0);else if(Sa(t)||typeof t=="string")Array.prototype.forEach.call(t,e,void 0);else for(var n=pI(t),s=fI(t),r=s.length,i=0;i<r;i++)e.call(void 0,s[i],n&&n[i],t)}var Yg=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function gI(t,e){if(t){t=t.split("&");for(var n=0;n<t.length;n++){var s=t[n].indexOf("="),r=null;if(0<=s){var i=t[n].substring(0,s);r=t[n].substring(s+1)}else i=t[n];e(i,r?decodeURIComponent(r.replace(/\+/g," ")):"")}}}function vs(t,e){if(this.g=this.s=this.j="",this.m=null,this.o=this.l="",this.h=!1,t instanceof vs){this.h=e!==void 0?e:t.h,Go(this,t.j),this.s=t.s,this.g=t.g,Qo(this,t.m),this.l=t.l,e=t.i;var n=new ci;n.i=e.i,e.g&&(n.g=new Map(e.g),n.h=e.h),Td(this,n),this.o=t.o}else t&&(n=String(t).match(Yg))?(this.h=!!e,Go(this,n[1]||"",!0),this.s=xr(n[2]||""),this.g=xr(n[3]||"",!0),Qo(this,n[4]),this.l=xr(n[5]||"",!0),Td(this,n[6]||"",!0),this.o=xr(n[7]||"")):(this.h=!!e,this.i=new ci(null,this.h))}vs.prototype.toString=function(){var t=[],e=this.j;e&&t.push(Mr(e,Id,!0),":");var n=this.g;return(n||e=="file")&&(t.push("//"),(e=this.s)&&t.push(Mr(e,Id,!0),"@"),t.push(encodeURIComponent(String(n)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),n=this.m,n!=null&&t.push(":",String(n))),(n=this.l)&&(this.g&&n.charAt(0)!="/"&&t.push("/"),t.push(Mr(n,n.charAt(0)=="/"?vI:yI,!0))),(n=this.i.toString())&&t.push("?",n),(n=this.o)&&t.push("#",Mr(n,wI)),t.join("")};function gn(t){return new vs(t)}function Go(t,e,n){t.j=n?xr(e,!0):e,t.j&&(t.j=t.j.replace(/:$/,""))}function Qo(t,e){if(e){if(e=Number(e),isNaN(e)||0>e)throw Error("Bad port number "+e);t.m=e}else t.m=null}function Td(t,e,n){e instanceof ci?(t.i=e,bI(t.i,t.h)):(n||(e=Mr(e,_I)),t.i=new ci(e,t.h))}function Se(t,e,n){t.i.set(e,n)}function La(t){return Se(t,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),t}function xr(t,e){return t?e?decodeURI(t.replace(/%25/g,"%2525")):decodeURIComponent(t):""}function Mr(t,e,n){return typeof t=="string"?(t=encodeURI(t).replace(e,mI),n&&(t=t.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),t):null}function mI(t){return t=t.charCodeAt(0),"%"+(t>>4&15).toString(16)+(t&15).toString(16)}var Id=/[#\/\?@]/g,yI=/[#\?:]/g,vI=/[#\?]/g,_I=/[#\?@]/g,wI=/#/g;function ci(t,e){this.h=this.g=null,this.i=t||null,this.j=!!e}function Xn(t){t.g||(t.g=new Map,t.h=0,t.i&&gI(t.i,function(e,n){t.add(decodeURIComponent(e.replace(/\+/g," ")),n)}))}$=ci.prototype;$.add=function(t,e){Xn(this),this.i=null,t=pr(this,t);var n=this.g.get(t);return n||this.g.set(t,n=[]),n.push(e),this.h+=1,this};function Jg(t,e){Xn(t),e=pr(t,e),t.g.has(e)&&(t.i=null,t.h-=t.g.get(e).length,t.g.delete(e))}function Zg(t,e){return Xn(t),e=pr(t,e),t.g.has(e)}$.forEach=function(t,e){Xn(this),this.g.forEach(function(n,s){n.forEach(function(r){t.call(e,r,s,this)},this)},this)};$.oa=function(){Xn(this);const t=Array.from(this.g.values()),e=Array.from(this.g.keys()),n=[];for(let s=0;s<e.length;s++){const r=t[s];for(let i=0;i<r.length;i++)n.push(e[s])}return n};$.W=function(t){Xn(this);let e=[];if(typeof t=="string")Zg(this,t)&&(e=e.concat(this.g.get(pr(this,t))));else{t=Array.from(this.g.values());for(let n=0;n<t.length;n++)e=e.concat(t[n])}return e};$.set=function(t,e){return Xn(this),this.i=null,t=pr(this,t),Zg(this,t)&&(this.h-=this.g.get(t).length),this.g.set(t,[e]),this.h+=1,this};$.get=function(t,e){return t?(t=this.W(t),0<t.length?String(t[0]):e):e};function em(t,e,n){Jg(t,e),0<n.length&&(t.i=null,t.g.set(pr(t,e),mu(n)),t.h+=n.length)}$.toString=function(){if(this.i)return this.i;if(!this.g)return"";const t=[],e=Array.from(this.g.keys());for(var n=0;n<e.length;n++){var s=e[n];const i=encodeURIComponent(String(s)),o=this.W(s);for(s=0;s<o.length;s++){var r=i;o[s]!==""&&(r+="="+encodeURIComponent(String(o[s]))),t.push(r)}}return this.i=t.join("&")};function pr(t,e){return e=String(e),t.j&&(e=e.toLowerCase()),e}function bI(t,e){e&&!t.j&&(Xn(t),t.i=null,t.g.forEach(function(n,s){var r=s.toLowerCase();s!=r&&(Jg(this,s),em(this,r,n))},t)),t.j=e}var EI=class{constructor(e,n){this.h=e,this.g=n}};function tm(t){this.l=t||TI,Y.PerformanceNavigationTiming?(t=Y.performance.getEntriesByType("navigation"),t=0<t.length&&(t[0].nextHopProtocol=="hq"||t[0].nextHopProtocol=="h2")):t=!!(Y.g&&Y.g.Ga&&Y.g.Ga()&&Y.g.Ga().$b),this.j=t?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}var TI=10;function nm(t){return t.h?!0:t.g?t.g.size>=t.j:!1}function sm(t){return t.h?1:t.g?t.g.size:0}function bl(t,e){return t.h?t.h==e:t.g?t.g.has(e):!1}function Ru(t,e){t.g?t.g.add(e):t.h=e}function rm(t,e){t.h&&t.h==e?t.h=null:t.g&&t.g.has(e)&&t.g.delete(e)}tm.prototype.cancel=function(){if(this.i=im(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const t of this.g.values())t.cancel();this.g.clear()}};function im(t){if(t.h!=null)return t.i.concat(t.h.D);if(t.g!=null&&t.g.size!==0){let e=t.i;for(const n of t.g.values())e=e.concat(n.D);return e}return mu(t.i)}function Ou(){}Ou.prototype.stringify=function(t){return Y.JSON.stringify(t,void 0)};Ou.prototype.parse=function(t){return Y.JSON.parse(t,void 0)};function II(){this.g=new Ou}function AI(t,e,n){const s=n||"";try{Xg(t,function(r,i){let o=r;Ni(r)&&(o=Tu(r)),e.push(s+i+"="+encodeURIComponent(o))})}catch(r){throw e.push(s+"type="+encodeURIComponent("_badmap")),r}}function SI(t,e){const n=new Na;if(Y.Image){const s=new Image;s.onload=io(ao,n,s,"TestLoadImage: loaded",!0,e),s.onerror=io(ao,n,s,"TestLoadImage: error",!1,e),s.onabort=io(ao,n,s,"TestLoadImage: abort",!1,e),s.ontimeout=io(ao,n,s,"TestLoadImage: timeout",!1,e),Y.setTimeout(function(){s.ontimeout&&s.ontimeout()},1e4),s.src=t}else e(!1)}function ao(t,e,n,s,r){try{e.onload=null,e.onerror=null,e.onabort=null,e.ontimeout=null,r(s)}catch{}}function Ui(t){this.l=t.ac||null,this.j=t.jb||!1}Je(Ui,Su);Ui.prototype.g=function(){return new Ua(this.l,this.j)};Ui.prototype.i=function(t){return function(){return t}}({});function Ua(t,e){Ge.call(this),this.D=t,this.u=e,this.m=void 0,this.readyState=Nu,this.status=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.v=new Headers,this.h=null,this.C="GET",this.B="",this.g=!1,this.A=this.j=this.l=null}Je(Ua,Ge);var Nu=0;$=Ua.prototype;$.open=function(t,e){if(this.readyState!=Nu)throw this.abort(),Error("Error reopening a connection");this.C=t,this.B=e,this.readyState=1,li(this)};$.send=function(t){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const e={headers:this.v,method:this.C,credentials:this.m,cache:void 0};t&&(e.body=t),(this.D||Y).fetch(new Request(this.B,e)).then(this.Wa.bind(this),this.ga.bind(this))};$.abort=function(){this.response=this.responseText="",this.v=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Fi(this)),this.readyState=Nu};$.Wa=function(t){if(this.g&&(this.l=t,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=t.headers,this.readyState=2,li(this)),this.g&&(this.readyState=3,li(this),this.g)))if(this.responseType==="arraybuffer")t.arrayBuffer().then(this.Ua.bind(this),this.ga.bind(this));else if(typeof Y.ReadableStream<"u"&&"body"in t){if(this.j=t.body.getReader(),this.u){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.A=new TextDecoder;om(this)}else t.text().then(this.Va.bind(this),this.ga.bind(this))};function om(t){t.j.read().then(t.Ta.bind(t)).catch(t.ga.bind(t))}$.Ta=function(t){if(this.g){if(this.u&&t.value)this.response.push(t.value);else if(!this.u){var e=t.value?t.value:new Uint8Array(0);(e=this.A.decode(e,{stream:!t.done}))&&(this.response=this.responseText+=e)}t.done?Fi(this):li(this),this.readyState==3&&om(this)}};$.Va=function(t){this.g&&(this.response=this.responseText=t,Fi(this))};$.Ua=function(t){this.g&&(this.response=t,Fi(this))};$.ga=function(){this.g&&Fi(this)};function Fi(t){t.readyState=4,t.l=null,t.j=null,t.A=null,li(t)}$.setRequestHeader=function(t,e){this.v.append(t,e)};$.getResponseHeader=function(t){return this.h&&this.h.get(t.toLowerCase())||""};$.getAllResponseHeaders=function(){if(!this.h)return"";const t=[],e=this.h.entries();for(var n=e.next();!n.done;)n=n.value,t.push(n[0]+": "+n[1]),n=e.next();return t.join(`\r
`)};function li(t){t.onreadystatechange&&t.onreadystatechange.call(t)}Object.defineProperty(Ua.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(t){this.m=t?"include":"same-origin"}});var CI=Y.JSON.parse;function Ne(t){Ge.call(this),this.headers=new Map,this.u=t||null,this.h=!1,this.C=this.g=null,this.H="",this.m=0,this.j="",this.l=this.F=this.v=this.D=!1,this.B=0,this.A=null,this.J=am,this.K=this.L=!1}Je(Ne,Ge);var am="",kI=/^https?$/i,RI=["POST","PUT"];$=Ne.prototype;$.Ka=function(t){this.L=t};$.da=function(t,e,n,s){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.H+"; newUri="+t);e=e?e.toUpperCase():"GET",this.H=t,this.j="",this.m=0,this.D=!1,this.h=!0,this.g=this.u?this.u.g():yl.g(),this.C=this.u?Ed(this.u):Ed(yl),this.g.onreadystatechange=rt(this.Ha,this);try{this.F=!0,this.g.open(e,String(t),!0),this.F=!1}catch(i){Ad(this,i);return}if(t=n||"",n=new Map(this.headers),s)if(Object.getPrototypeOf(s)===Object.prototype)for(var r in s)n.set(r,s[r]);else if(typeof s.keys=="function"&&typeof s.get=="function")for(const i of s.keys())n.set(i,s.get(i));else throw Error("Unknown input type for opt_headers: "+String(s));s=Array.from(n.keys()).find(i=>i.toLowerCase()=="content-type"),r=Y.FormData&&t instanceof Y.FormData,!(0<=Tg(RI,e))||s||r||n.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[i,o]of n)this.g.setRequestHeader(i,o);this.J&&(this.g.responseType=this.J),"withCredentials"in this.g&&this.g.withCredentials!==this.L&&(this.g.withCredentials=this.L);try{um(this),0<this.B&&((this.K=OI(this.g))?(this.g.timeout=this.B,this.g.ontimeout=rt(this.qa,this)):this.A=Au(this.qa,this.B,this)),this.v=!0,this.g.send(t),this.v=!1}catch(i){Ad(this,i)}};function OI(t){return rr&&WT()&&typeof t.timeout=="number"&&t.ontimeout!==void 0}$.qa=function(){typeof gu<"u"&&this.g&&(this.j="Timed out after "+this.B+"ms, aborting",this.m=8,Ye(this,"timeout"),this.abort(8))};function Ad(t,e){t.h=!1,t.g&&(t.l=!0,t.g.abort(),t.l=!1),t.j=e,t.m=5,cm(t),Fa(t)}function cm(t){t.D||(t.D=!0,Ye(t,"complete"),Ye(t,"error"))}$.abort=function(t){this.g&&this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1,this.m=t||7,Ye(this,"complete"),Ye(this,"abort"),Fa(this))};$.M=function(){this.g&&(this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1),Fa(this,!0)),Ne.X.M.call(this)};$.Ha=function(){this.s||(this.F||this.v||this.l?lm(this):this.fb())};$.fb=function(){lm(this)};function lm(t){if(t.h&&typeof gu<"u"&&(!t.C[1]||an(t)!=4||t.aa()!=2)){if(t.v&&an(t)==4)Au(t.Ha,0,t);else if(Ye(t,"readystatechange"),an(t)==4){t.h=!1;try{const a=t.aa();e:switch(a){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var e=!0;break e;default:e=!1}var n;if(!(n=e)){var s;if(s=a===0){var r=String(t.H).match(Yg)[1]||null;if(!r&&Y.self&&Y.self.location){var i=Y.self.location.protocol;r=i.substr(0,i.length-1)}s=!kI.test(r?r.toLowerCase():"")}n=s}if(n)Ye(t,"complete"),Ye(t,"success");else{t.m=6;try{var o=2<an(t)?t.g.statusText:""}catch{o=""}t.j=o+" ["+t.aa()+"]",cm(t)}}finally{Fa(t)}}}}function Fa(t,e){if(t.g){um(t);const n=t.g,s=t.C[0]?qo:null;t.g=null,t.C=null,e||Ye(t,"ready");try{n.onreadystatechange=s}catch{}}}function um(t){t.g&&t.K&&(t.g.ontimeout=null),t.A&&(Y.clearTimeout(t.A),t.A=null)}function an(t){return t.g?t.g.readyState:0}$.aa=function(){try{return 2<an(this)?this.g.status:-1}catch{return-1}};$.fa=function(){try{return this.g?this.g.responseText:""}catch{return""}};$.Sa=function(t){if(this.g){var e=this.g.responseText;return t&&e.indexOf(t)==0&&(e=e.substring(t.length)),CI(e)}};function Sd(t){try{if(!t.g)return null;if("response"in t.g)return t.g.response;switch(t.J){case am:case"text":return t.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in t.g)return t.g.mozResponseArrayBuffer}return null}catch{return null}}$.Ea=function(){return this.m};$.Oa=function(){return typeof this.j=="string"?this.j:String(this.j)};function hm(t){let e="";return vu(t,function(n,s){e+=s,e+=":",e+=n,e+=`\r
`}),e}function Pu(t,e,n){e:{for(s in n){var s=!1;break e}s=!0}s||(n=hm(n),typeof t=="string"?n!=null&&encodeURIComponent(String(n)):Se(t,e,n))}function Ir(t,e,n){return n&&n.internalChannelParams&&n.internalChannelParams[t]||e}function dm(t){this.Ca=0,this.i=[],this.j=new Na,this.ka=this.sa=this.F=this.V=this.g=this.za=this.D=this.ia=this.o=this.S=this.s=null,this.ab=this.U=0,this.Za=Ir("failFast",!1,t),this.L=this.v=this.u=this.m=this.l=null,this.Y=!0,this.pa=this.Ba=this.T=-1,this.Z=this.A=this.C=0,this.Xa=Ir("baseRetryDelayMs",5e3,t),this.bb=Ir("retryDelaySeedMs",1e4,t),this.$a=Ir("forwardChannelMaxRetries",2,t),this.ta=Ir("forwardChannelRequestTimeoutMs",2e4,t),this.ra=t&&t.xmlHttpFactory||void 0,this.Da=t&&t.Zb||!1,this.J=void 0,this.H=t&&t.supportsCrossDomainXhr||!1,this.I="",this.h=new tm(t&&t.concurrentRequestLimit),this.Fa=new II,this.O=t&&t.fastHandshake||!1,this.N=t&&t.encodeInitMessageHeaders||!1,this.O&&this.N&&(this.N=!1),this.Ya=t&&t.Xb||!1,t&&t.Aa&&this.j.Aa(),t&&t.forceLongPolling&&(this.Y=!1),this.$=!this.O&&this.Y&&t&&t.detectBufferingProxy||!1,this.ja=void 0,this.P=0,this.K=!1,this.la=this.B=null}$=dm.prototype;$.ma=8;$.G=1;function Du(t){if(fm(t),t.G==3){var e=t.U++,n=gn(t.F);Se(n,"SID",t.I),Se(n,"RID",e),Se(n,"TYPE","terminate"),$i(t,n),e=new Mi(t,t.j,e,void 0),e.K=2,e.v=La(gn(n)),n=!1,Y.navigator&&Y.navigator.sendBeacon&&(n=Y.navigator.sendBeacon(e.v.toString(),"")),!n&&Y.Image&&(new Image().src=e.v,n=!0),n||(e.g=bm(e.l,null),e.g.da(e.v)),e.F=Date.now(),Li(e)}_m(t)}function $a(t){t.g&&(Mu(t),t.g.cancel(),t.g=null)}function fm(t){$a(t),t.u&&(Y.clearTimeout(t.u),t.u=null),Xo(t),t.h.cancel(),t.m&&(typeof t.m=="number"&&Y.clearTimeout(t.m),t.m=null)}function Ba(t){nm(t.h)||t.m||(t.m=!0,Mg(t.Ja,t),t.C=0)}function NI(t,e){return sm(t.h)>=t.h.j-(t.m?1:0)?!1:t.m?(t.i=e.D.concat(t.i),!0):t.G==1||t.G==2||t.C>=(t.Za?0:t.$a)?!1:(t.m=Di(rt(t.Ja,t,e),vm(t,t.C)),t.C++,!0)}$.Ja=function(t){if(this.m)if(this.m=null,this.G==1){if(!t){this.U=Math.floor(1e5*Math.random()),t=this.U++;const r=new Mi(this,this.j,t,void 0);let i=this.s;if(this.S&&(i?(i=Cg(i),kg(i,this.S)):i=this.S),this.o!==null||this.N||(r.H=i,i=null),this.O)e:{for(var e=0,n=0;n<this.i.length;n++){t:{var s=this.i[n];if("__data__"in s.g&&(s=s.g.__data__,typeof s=="string")){s=s.length;break t}s=void 0}if(s===void 0)break;if(e+=s,4096<e){e=n;break e}if(e===4096||n===this.i.length-1){e=n+1;break e}}e=1e3}else e=1e3;e=pm(this,r,e),n=gn(this.F),Se(n,"RID",t),Se(n,"CVER",22),this.D&&Se(n,"X-HTTP-Session-Id",this.D),$i(this,n),i&&(this.N?e="headers="+encodeURIComponent(String(hm(i)))+"&"+e:this.o&&Pu(n,this.o,i)),Ru(this.h,r),this.Ya&&Se(n,"TYPE","init"),this.O?(Se(n,"$req",e),Se(n,"SID","null"),r.Z=!0,_l(r,n,null)):_l(r,n,e),this.G=2}}else this.G==3&&(t?Cd(this,t):this.i.length==0||nm(this.h)||Cd(this))};function Cd(t,e){var n;e?n=e.m:n=t.U++;const s=gn(t.F);Se(s,"SID",t.I),Se(s,"RID",n),Se(s,"AID",t.T),$i(t,s),t.o&&t.s&&Pu(s,t.o,t.s),n=new Mi(t,t.j,n,t.C+1),t.o===null&&(n.H=t.s),e&&(t.i=e.D.concat(t.i)),e=pm(t,n,1e3),n.setTimeout(Math.round(.5*t.ta)+Math.round(.5*t.ta*Math.random())),Ru(t.h,n),_l(n,s,e)}function $i(t,e){t.ia&&vu(t.ia,function(n,s){Se(e,s,n)}),t.l&&Xg({},function(n,s){Se(e,s,n)})}function pm(t,e,n){n=Math.min(t.i.length,n);var s=t.l?rt(t.l.Ra,t.l,t):null;e:{var r=t.i;let i=-1;for(;;){const o=["count="+n];i==-1?0<n?(i=r[0].h,o.push("ofs="+i)):i=0:o.push("ofs="+i);let a=!0;for(let c=0;c<n;c++){let l=r[c].h;const u=r[c].g;if(l-=i,0>l)i=Math.max(0,r[c].h-100),a=!1;else try{AI(u,o,"req"+l+"_")}catch{s&&s(u)}}if(a){s=o.join("&");break e}}}return t=t.i.splice(0,n),e.D=t,s}function gm(t){t.g||t.u||(t.Z=1,Mg(t.Ia,t),t.A=0)}function xu(t){return t.g||t.u||3<=t.A?!1:(t.Z++,t.u=Di(rt(t.Ia,t),vm(t,t.A)),t.A++,!0)}$.Ia=function(){if(this.u=null,mm(this),this.$&&!(this.K||this.g==null||0>=this.P)){var t=2*this.P;this.j.info("BP detection timer enabled: "+t),this.B=Di(rt(this.eb,this),t)}};$.eb=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.L=!1,this.K=!0,ft(10),$a(this),mm(this))};function Mu(t){t.B!=null&&(Y.clearTimeout(t.B),t.B=null)}function mm(t){t.g=new Mi(t,t.j,"rpc",t.Z),t.o===null&&(t.g.H=t.s),t.g.N=0;var e=gn(t.sa);Se(e,"RID","rpc"),Se(e,"SID",t.I),Se(e,"CI",t.L?"0":"1"),Se(e,"AID",t.T),Se(e,"TYPE","xmlhttp"),$i(t,e),t.o&&t.s&&Pu(e,t.o,t.s),t.J&&t.g.setTimeout(t.J);var n=t.g;t=t.ka,n.K=1,n.v=La(gn(e)),n.s=null,n.P=!0,Kg(n,t)}$.cb=function(){this.v!=null&&(this.v=null,$a(this),xu(this),ft(19))};function Xo(t){t.v!=null&&(Y.clearTimeout(t.v),t.v=null)}function ym(t,e){var n=null;if(t.g==e){Xo(t),Mu(t),t.g=null;var s=2}else if(bl(t.h,e))n=e.D,rm(t.h,e),s=1;else return;if(t.G!=0){if(t.pa=e.Y,e.i)if(s==1){n=e.s?e.s.length:0,e=Date.now()-e.F;var r=t.C;s=Pa(),Ye(s,new jg(s,n)),Ba(t)}else gm(t);else if(r=e.o,r==3||r==0&&0<t.pa||!(s==1&&NI(t,e)||s==2&&xu(t)))switch(n&&0<n.length&&(e=t.h,e.i=e.i.concat(n)),r){case 1:ls(t,5);break;case 4:ls(t,10);break;case 3:ls(t,6);break;default:ls(t,2)}}}function vm(t,e){let n=t.Xa+Math.floor(Math.random()*t.bb);return t.l||(n*=2),n*e}function ls(t,e){if(t.j.info("Error code "+e),e==2){var n=null;t.l&&(n=null);var s=rt(t.kb,t);n||(n=new vs("//www.google.com/images/cleardot.gif"),Y.location&&Y.location.protocol=="http"||Go(n,"https"),La(n)),SI(n.toString(),s)}else ft(2);t.G=0,t.l&&t.l.va(e),_m(t),fm(t)}$.kb=function(t){t?(this.j.info("Successfully pinged google.com"),ft(2)):(this.j.info("Failed to ping google.com"),ft(1))};function _m(t){if(t.G=0,t.la=[],t.l){const e=im(t.h);(e.length!=0||t.i.length!=0)&&(md(t.la,e),md(t.la,t.i),t.h.i.length=0,mu(t.i),t.i.length=0),t.l.ua()}}function wm(t,e,n){var s=n instanceof vs?gn(n):new vs(n,void 0);if(s.g!="")e&&(s.g=e+"."+s.g),Qo(s,s.m);else{var r=Y.location;s=r.protocol,e=e?e+"."+r.hostname:r.hostname,r=+r.port;var i=new vs(null,void 0);s&&Go(i,s),e&&(i.g=e),r&&Qo(i,r),n&&(i.l=n),s=i}return n=t.D,e=t.za,n&&e&&Se(s,n,e),Se(s,"VER",t.ma),$i(t,s),s}function bm(t,e,n){if(e&&!t.H)throw Error("Can't create secondary domain capable XhrIo object.");return e=n&&t.Da&&!t.ra?new Ne(new Ui({jb:!0})):new Ne(t.ra),e.Ka(t.H),e}function Em(){}$=Em.prototype;$.xa=function(){};$.wa=function(){};$.va=function(){};$.ua=function(){};$.Ra=function(){};function Yo(){if(rr&&!(10<=Number(GT)))throw Error("Environmental error: no available transport.")}Yo.prototype.g=function(t,e){return new wt(t,e)};function wt(t,e){Ge.call(this),this.g=new dm(e),this.l=t,this.h=e&&e.messageUrlParams||null,t=e&&e.messageHeaders||null,e&&e.clientProtocolHeaderRequired&&(t?t["X-Client-Protocol"]="webchannel":t={"X-Client-Protocol":"webchannel"}),this.g.s=t,t=e&&e.initMessageHeaders||null,e&&e.messageContentType&&(t?t["X-WebChannel-Content-Type"]=e.messageContentType:t={"X-WebChannel-Content-Type":e.messageContentType}),e&&e.ya&&(t?t["X-WebChannel-Client-Profile"]=e.ya:t={"X-WebChannel-Client-Profile":e.ya}),this.g.S=t,(t=e&&e.Yb)&&!zo(t)&&(this.g.o=t),this.A=e&&e.supportsCrossDomainXhr||!1,this.v=e&&e.sendRawJson||!1,(e=e&&e.httpSessionIdParam)&&!zo(e)&&(this.g.D=e,t=this.h,t!==null&&e in t&&(t=this.h,e in t&&delete t[e])),this.j=new gr(this)}Je(wt,Ge);wt.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.H=!0);var t=this.g,e=this.l,n=this.h||void 0;ft(0),t.V=e,t.ia=n||{},t.L=t.Y,t.F=wm(t,null,t.V),Ba(t)};wt.prototype.close=function(){Du(this.g)};wt.prototype.u=function(t){var e=this.g;if(typeof t=="string"){var n={};n.__data__=t,t=n}else this.v&&(n={},n.__data__=Tu(t),t=n);e.i.push(new EI(e.ab++,t)),e.G==3&&Ba(e)};wt.prototype.M=function(){this.g.l=null,delete this.j,Du(this.g),delete this.g,wt.X.M.call(this)};function Tm(t){Cu.call(this);var e=t.__sm__;if(e){e:{for(const n in e){t=n;break e}t=void 0}(this.i=t)&&(t=this.i,e=e!==null&&t in e?e[t]:void 0),this.data=e}else this.data=t}Je(Tm,Cu);function Im(){ku.call(this),this.status=1}Je(Im,ku);function gr(t){this.g=t}Je(gr,Em);gr.prototype.xa=function(){Ye(this.g,"a")};gr.prototype.wa=function(t){Ye(this.g,new Tm(t))};gr.prototype.va=function(t){Ye(this.g,new Im)};gr.prototype.ua=function(){Ye(this.g,"b")};Yo.prototype.createWebChannel=Yo.prototype.g;wt.prototype.send=wt.prototype.u;wt.prototype.open=wt.prototype.m;wt.prototype.close=wt.prototype.close;Da.NO_ERROR=0;Da.TIMEOUT=8;Da.HTTP_ERROR=6;Hg.COMPLETE="complete";qg.EventType=xi;xi.OPEN="a";xi.CLOSE="b";xi.ERROR="c";xi.MESSAGE="d";Ge.prototype.listen=Ge.prototype.N;Ne.prototype.listenOnce=Ne.prototype.O;Ne.prototype.getLastError=Ne.prototype.Oa;Ne.prototype.getLastErrorCode=Ne.prototype.Ea;Ne.prototype.getStatus=Ne.prototype.aa;Ne.prototype.getResponseJson=Ne.prototype.Sa;Ne.prototype.getResponseText=Ne.prototype.fa;Ne.prototype.send=Ne.prototype.da;Ne.prototype.setWithCredentials=Ne.prototype.Ka;var PI=function(){return new Yo},DI=function(){return Pa()},Tc=Da,xI=Hg,MI=Ps,kd={sb:0,vb:1,wb:2,Pb:3,Ub:4,Rb:5,Sb:6,Qb:7,Ob:8,Tb:9,PROXY:10,NOPROXY:11,Mb:12,Ib:13,Jb:14,Hb:15,Kb:16,Lb:17,ob:18,nb:19,pb:20},LI=Ui,co=qg,UI=Ne;const Rd="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const As=new fu("@firebase/firestore");function Od(){return As.logLevel}function B(t,...e){if(As.logLevel<=pe.DEBUG){const n=e.map(Lu);As.debug(`Firestore (${mr}): ${t}`,...n)}}function mn(t,...e){if(As.logLevel<=pe.ERROR){const n=e.map(Lu);As.error(`Firestore (${mr}): ${t}`,...n)}}function Jo(t,...e){if(As.logLevel<=pe.WARN){const n=e.map(Lu);As.warn(`Firestore (${mr}): ${t}`,...n)}}function Lu(t){if(typeof t=="string")return t;try{return e=t,JSON.stringify(e)}catch{return t}/**
* @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nd(t){let e=0;for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e++;return e}function yr(t,e){for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e(n,t[n])}function Cm(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class d0{constructor(e,n=null,s=[],r=[],i=null,o=null,a=null){this.path=e,this.collectionGroup=n,this.orderBy=s,this.filters=r,this.limit=i,this.startAt=o,this.endAt=a,this.ft=null}}function Fd(t,e=null,n=[],s=[],r=null,i=null,o=null){return new d0(t,e,n,s,r,i,o)}function $u(t){const e=ne(t);if(e.ft===null){let n=e.path.canonicalString();e.collectionGroup!==null&&(n+="|cg:"+e.collectionGroup),n+="|f:",n+=e.filters.map(s=>Il(s)).join(","),n+="|ob:",n+=e.orderBy.map(s=>function(r){return r.field.canonicalString()+r.dir}(s)).join(","),Va(e.limit)||(n+="|l:",n+=e.limit),e.startAt&&(n+="|lb:",n+=e.startAt.inclusive?"b:":"a:",n+=e.startAt.position.map(s=>cr(s)).join(",")),e.endAt&&(n+="|ub:",n+=e.endAt.inclusive?"a:":"b:",n+=e.endAt.position.map(s=>cr(s)).join(",")),e.ft=n}return e.ft}function Bu(t,e){if(t.limit!==e.limit||t.orderBy.length!==e.orderBy.length)return!1;for(let n=0;n<t.orderBy.length;n++)if(!s0(t.orderBy[n],e.orderBy[n]))return!1;if(t.filters.length!==e.filters.length)return!1;for(let n=0;n<t.filters.length;n++)if(!xm(t.filters[n],e.filters[n]))return!1;return t.collectionGroup===e.collectionGroup&&!!t.path.isEqual(e.path)&&!!Ud(t.startAt,e.startAt)&&Ud(t.endAt,e.endAt)}function Al(t){return H.isDocumentKey(t.path)&&t.collectionGroup===null&&t.filters.length===0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class za{constructor(){this._=void 0}}function I0(t,e,n){return t instanceof ta?function(s,r){const i={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return r&&(i.fields.__previous_value__=r),{mapValue:i}}(n,e):t instanceof pi?Wm(t,e):t instanceof gi?Gm(t,e):function(s,r){const i=Km(s,r),o=Bd(i)+Bd(s._t);return Tl(i)&&Tl(s._t)?zm(o):qm(s.serializer,o)}(t,e)}function A0(t,e,n){return t instanceof pi?Wm(t,e):t instanceof gi?Gm(t,e):n}function Km(t,e){return t instanceof na?Tl(n=e)||function(s){return!!s&&"doubleValue"in s}(n)?e:{integerValue:0}:null;var n}class ta extends za{}class pi extends za{constructor(e){super(),this.elements=e}}function Wm(t,e){const n=Qm(e);for(const s of t.elements)n.some(r=>Jt(r,s))||n.push(s);return{arrayValue:{values:n}}}class gi extends za{constructor(e){super(),this.elements=e}}function Gm(t,e){let n=Qm(e);for(const s of t.elements)n=n.filter(r=>!Jt(r,s));return{arrayValue:{values:n}}}class na extends za{constructor(e,n){super(),this.serializer=e,this._t=n}}function Bd(t){return Ue(t.integerValue||t.doubleValue)}function Qm(t){return Fu(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}function S0(t,e){return t.field.isEqual(e.field)&&function(n,s){return n instanceof pi&&s instanceof pi||n instanceof gi&&s instanceof gi?ir(n.elements,s.elements,Jt):n instanceof na&&s instanceof na?Jt(n._t,s._t):n instanceof ta&&s instanceof ta}(t.transform,e.transform)}class C0{constructor(e,n){this.version=e,this.transformResults=n}}class dn{constructor(e,n){this.updateTime=e,this.exists=n}static none(){return new dn}static exists(e){return new dn(void 0,e)}static updateTime(e){return new dn(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function Co(t,e){return t.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(t.updateTime):t.exists===void 0||t.exists===e.isFoundDocument()}class Ka{}function Xm(t,e){if(!t.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return t.isNoDocument()?new Jm(t.key,dn.none()):new ji(t.key,t.data,dn.none());{const n=t.data,s=St.empty();let r=new qe(st.comparator);for(let i of e.fields)if(!r.has(i)){let o=n.field(i);o===null&&i.length>1&&(i=i.popLast(),o=n.field(i)),o===null?s.delete(i):s.set(i,o),r=r.add(i)}return new Ds(t.key,s,new Lt(r.toArray()),dn.none())}}function k0(t,e,n){t instanceof ji?function(s,r,i){const o=s.value.clone(),a=jd(s.fieldTransforms,r,i.transformResults);o.setAll(a),r.convertToFoundDocument(i.version,o).setHasCommittedMutations()}(t,e,n):t instanceof Ds?function(s,r,i){if(!Co(s.precondition,r))return void r.convertToUnknownDocument(i.version);const o=jd(s.fieldTransforms,r,i.transformResults),a=r.data;a.setAll(Ym(s)),a.setAll(o),r.convertToFoundDocument(i.version,a).setHasCommittedMutations()}(t,e,n):function(s,r,i){r.convertToNoDocument(i.version).setHasCommittedMutations()}(0,e,n)}function Kr(t,e,n,s){return t instanceof ji?function(r,i,o,a){if(!Co(r.precondition,i))return o;const c=r.value.clone(),l=Hd(r.fieldTransforms,a,i);return c.setAll(l),i.convertToFoundDocument(i.version,c).setHasLocalMutations(),null}(t,e,n,s):t instanceof Ds?function(r,i,o,a){if(!Co(r.precondition,i))return o;const c=Hd(r.fieldTransforms,a,i),l=i.data;return l.setAll(Ym(r)),l.setAll(c),i.convertToFoundDocument(i.version,l).setHasLocalMutations(),o===null?null:o.unionWith(r.fieldMask.fields).unionWith(r.fieldTransforms.map(u=>u.field))}(t,e,n,s):function(r,i,o){return Co(r.precondition,i)?(i.convertToNoDocument(i.version).setHasLocalMutations(),null):o}(t,e,n)}function R0(t,e){let n=null;for(const s of t.fieldTransforms){const r=e.data.field(s.field),i=Km(s.transform,r||null);i!=null&&(n===null&&(n=St.empty()),n.set(s.field,i))}return n||null}function Vd(t,e){return t.type===e.type&&!!t.key.isEqual(e.key)&&!!t.precondition.isEqual(e.precondition)&&!!function(n,s){return n===void 0&&s===void 0||!(!n||!s)&&ir(n,s,(r,i)=>S0(r,i))}(t.fieldTransforms,e.fieldTransforms)&&(t.type===0?t.value.isEqual(e.value):t.type!==1||t.data.isEqual(e.data)&&t.fieldMask.isEqual(e.fieldMask))}class ji extends Ka{constructor(e,n,s,r=[]){super(),this.key=e,this.value=n,this.precondition=s,this.fieldTransforms=r,this.type=0}getFieldMask(){return null}}class Ds extends Ka{constructor(e,n,s,r,i=[]){super(),this.key=e,this.data=n,this.fieldMask=s,this.precondition=r,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function Ym(t){const e=new Map;return t.fieldMask.fields.forEach(n=>{if(!n.isEmpty()){const s=t.data.field(n);e.set(n,s)}}),e}function jd(t,e,n){const s=new Map;Ie(t.length===n.length);for(let r=0;r<n.length;r++){const i=t[r],o=i.transform,a=e.data.field(i.field);s.set(i.field,A0(o,a,n[r]))}return s}function Hd(t,e,n){const s=new Map;for(const r of t){const i=r.transform,o=n.data.field(r.field);s.set(r.field,I0(i,o,e))}return s}class Jm extends Ka{constructor(e,n){super(),this.key=e,this.precondition=n,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class O0 extends Ka{constructor(e,n){super(),this.key=e,this.precondition=n,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const L0=(()=>({asc:"ASCENDING",desc:"DESCENDING"}))(),U0=(()=>({"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"}))(),F0=(()=>({and:"AND",or:"OR"}))();class $0{constructor(e,n){this.databaseId=e,this.useProto3Json=n}}function sa(t,e){return t.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function ny(t,e){return t.useProto3Json?e.toBase64():e.toUint8Array()}function B0(t,e){return sa(t,e.toTimestamp())}function Kt(t){return Ie(!!t),Z.fromTimestamp(function(e){const n=zn(e);return new He(n.seconds,n.nanos)}(t))}function Hu(t,e){return function(n){return new Ce(["projects",n.projectId,"databases",n.database])}(t).child("documents").child(e).canonicalString()}function sy(t){const e=Ce.fromString(t);return Ie(ay(e)),e}function kl(t,e){return Hu(t.databaseId,e.path)}function Ic(t,e){const n=sy(e);if(n.get(1)!==t.databaseId.projectId)throw new K(I.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+n.get(1)+" vs "+t.databaseId.projectId);if(n.get(3)!==t.databaseId.database)throw new K(I.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+n.get(3)+" vs "+t.databaseId.database);return new H(ry(n))}function Rl(t,e){return Hu(t.databaseId,e)}function V0(t){const e=sy(t);return e.length===4?Ce.emptyPath():ry(e)}function Ol(t){return new Ce(["projects",t.databaseId.projectId,"databases",t.databaseId.database]).canonicalString()}function ry(t){return Ie(t.length>4&&t.get(4)==="documents"),t.popFirst(5)}function Wd(t,e,n){return{name:kl(t,e),fields:n.value.mapValue.fields}}function j0(t,e){let n;if("targetChange"in e){e.targetChange;const s=function(c){return c==="NO_CHANGE"?0:c==="ADD"?1:c==="REMOVE"?2:c==="CURRENT"?3:c==="RESET"?4:X()}(e.targetChange.targetChangeType||"NO_CHANGE"),r=e.targetChange.targetIds||[],i=function(c,l){return c.useProto3Json?(Ie(l===void 0||typeof l=="string"),at.fromBase64String(l||"")):(Ie(l===void 0||l instanceof Uint8Array),at.fromUint8Array(l||new Uint8Array))}(t,e.targetChange.resumeToken),o=e.targetChange.cause,a=o&&function(c){const l=c.code===void 0?I.UNKNOWN:Zm(c.code);return new K(l,c.message||"")}(o);n=new ty(s,r,i,a||null)}else if("documentChange"in e){e.documentChange;const s=e.documentChange;s.document,s.document.name,s.document.updateTime;const r=Ic(t,s.document.name),i=Kt(s.document.updateTime),o=s.document.createTime?Kt(s.document.createTime):Z.min(),a=new St({mapValue:{fields:s.document.fields}}),c=tt.newFoundDocument(r,i,o,a),l=s.targetIds||[],u=s.removedTargetIds||[];n=new ko(l,u,c.key,c)}else if("documentDelete"in e){e.documentDelete;const s=e.documentDelete;s.document;const r=Ic(t,s.document),i=s.readTime?Kt(s.readTime):Z.min(),o=tt.newNoDocument(r,i),a=s.removedTargetIds||[];n=new ko([],a,o.key,o)}else if("documentRemove"in e){e.documentRemove;const s=e.documentRemove;s.document;const r=Ic(t,s.document),i=s.removedTargetIds||[];n=new ko([],i,r,null)}else{if(!("filter"in e))return X();{e.filter;const s=e.filter;s.targetId;const r=s.count||0,i=new D0(r),o=s.targetId;n=new ey(o,i)}}return n}function H0(t,e){let n;if(e instanceof ji)n={update:Wd(t,e.key,e.value)};else if(e instanceof Jm)n={delete:kl(t,e.key)};else if(e instanceof Ds)n={update:Wd(t,e.key,e.data),updateMask:J0(e.fieldMask)};else{if(!(e instanceof O0))return X();n={verify:kl(t,e.key)}}return e.fieldTransforms.length>0&&(n.updateTransforms=e.fieldTransforms.map(s=>function(r,i){const o=i.transform;if(o instanceof ta)return{fieldPath:i.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(o instanceof pi)return{fieldPath:i.field.canonicalString(),appendMissingElements:{values:o.elements}};if(o instanceof gi)return{fieldPath:i.field.canonicalString(),removeAllFromArray:{values:o.elements}};if(o instanceof na)return{fieldPath:i.field.canonicalString(),increment:o._t};throw X()}(0,s))),e.precondition.isNone||(n.currentDocument=function(s,r){return r.updateTime!==void 0?{updateTime:B0(s,r.updateTime)}:r.exists!==void 0?{exists:r.exists}:X()}(t,e.precondition)),n}function q0(t,e){return t&&t.length>0?(Ie(e!==void 0),t.map(n=>function(s,r){let i=s.updateTime?Kt(s.updateTime):Kt(r);return i.isEqual(Z.min())&&(i=Kt(r)),new C0(i,s.transformResults||[])}(n,e))):[]}function z0(t,e){return{documents:[Rl(t,e.path)]}}function K0(t,e){const n={structuredQuery:{}},s=e.path;e.collectionGroup!==null?(n.parent=Rl(t,s),n.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(n.parent=Rl(t,s.popLast()),n.structuredQuery.from=[{collectionId:s.lastSegment()}]);const r=function(c){if(c.length!==0)return oy(Zt.create(c,"and"))}(e.filters);r&&(n.structuredQuery.where=r);const i=function(c){if(c.length!==0)return c.map(l=>function(u){return{field:zs(u.field),direction:Q0(u.dir)}}(l))}(e.orderBy);i&&(n.structuredQuery.orderBy=i);const o=function(c,l){return c.useProto3Json||Va(l)?l:{value:l}}(t,e.limit);var a;return o!==null&&(n.structuredQuery.limit=o),e.startAt&&(n.structuredQuery.startAt={before:(a=e.startAt).inclusive,values:a.position}),e.endAt&&(n.structuredQuery.endAt=function(c){return{before:!c.inclusive,values:c.position}}(e.endAt)),n}function W0(t){let e=V0(t.parent);const n=t.structuredQuery,s=n.from?n.from.length:0;let r=null;if(s>0){Ie(s===1);const u=n.from[0];u.allDescendants?r=u.collectionId:e=e.child(u.collectionId)}let i=[];n.where&&(i=function(u){const h=iy(u);return h instanceof Zt&&Dm(h)?h.getFilters():[h]}(n.where));let o=[];n.orderBy&&(o=n.orderBy.map(u=>function(h){return new qr(Ks(h.field),function(d){switch(d){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(h.direction))}(u)));let a=null;n.limit&&(a=function(u){let h;return h=typeof u=="object"?u.value:u,Va(h)?null:h}(n.limit));let c=null;n.startAt&&(c=function(u){const h=!!u.before,d=u.values||[];return new ea(d,h)}(n.startAt));let l=null;return n.endAt&&(l=function(u){const h=!u.before,d=u.values||[];return new ea(d,h)}(n.endAt)),f0(e,r,o,i,a,"F",c,l)}function G0(t,e){const n=function(s,r){switch(r){case 0:return null;case 1:return"existence-filter-mismatch";case 2:return"limbo-document";default:return X()}}(0,e.purpose);return n==null?null:{"goog-listen-tags":n}}function iy(t){return t.unaryFilter!==void 0?function(e){switch(e.unaryFilter.op){case"IS_NAN":const n=Ks(e.unaryFilter.field);return Be.create(n,"==",{doubleValue:NaN});case"IS_NULL":const s=Ks(e.unaryFilter.field);return Be.create(s,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const r=Ks(e.unaryFilter.field);return Be.create(r,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const i=Ks(e.unaryFilter.field);return Be.create(i,"!=",{nullValue:"NULL_VALUE"});default:return X()}}(t):t.fieldFilter!==void 0?function(e){return Be.create(Ks(e.fieldFilter.field),function(n){switch(n){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";default:return X()}}(e.fieldFilter.op),e.fieldFilter.value)}(t):t.compositeFilter!==void 0?function(e){return Zt.create(e.compositeFilter.filters.map(n=>iy(n)),function(n){switch(n){case"AND":return"and";case"OR":return"or";default:return X()}}(e.compositeFilter.op))}(t):X()}function Q0(t){return L0[t]}function X0(t){return U0[t]}function Y0(t){return F0[t]}function zs(t){return{fieldPath:t.canonicalString()}}function Ks(t){return st.fromServerFormat(t.fieldPath)}function oy(t){return t instanceof Be?function(e){if(e.op==="=="){if(Md(e.value))return{unaryFilter:{field:zs(e.field),op:"IS_NAN"}};if(xd(e.value))return{unaryFilter:{field:zs(e.field),op:"IS_NULL"}}}else if(e.op==="!="){if(Md(e.value))return{unaryFilter:{field:zs(e.field),op:"IS_NOT_NAN"}};if(xd(e.value))return{unaryFilter:{field:zs(e.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:zs(e.field),op:X0(e.op),value:e.value}}}(t):t instanceof Zt?function(e){const n=e.getFilters().map(s=>oy(s));return n.length===1?n[0]:{compositeFilter:{op:Y0(e.op),filters:n}}}(t):X()}function J0(t){const e=[];return t.fields.forEach(n=>e.push(n.canonicalString())),{fieldPaths:e}}function ay(t){return t.length>=4&&t.get(0)==="projects"&&t.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class PA{constructor(e,n,s,r,i){this.localStore=e,this.datastore=n,this.asyncQueue=s,this.remoteSyncer={},this.lu=[],this.fu=new Map,this.du=new Set,this.wu=[],this._u=i,this._u.qr(o=>{s.enqueueAndForget(async()=>{xs(this)&&(B("RemoteStore","Restarting streams for network reachability change."),await async function(a){const c=ne(a);c.du.add(4),await qi(c),c.mu.set("Unknown"),c.du.delete(4),await Qa(c)}(this))})}),this.mu=new NA(s,r)}}async function Qa(t){if(xs(t))for(const e of t.wu)await e(!0)}async function qi(t){for(const e of t.wu)await e(!1)}function dy(t,e){const n=ne(t);n.fu.has(e.targetId)||(n.fu.set(e.targetId,e),Qu(n)?Gu(n):_r(n).No()&&Wu(n,e))}function fy(t,e){const n=ne(t),s=_r(n);n.fu.delete(e),s.No()&&py(n,e),n.fu.size===0&&(s.No()?s.$o():xs(n)&&n.mu.set("Unknown"))}function Wu(t,e){t.gu.Ot(e.targetId),_r(t).jo(e)}function py(t,e){t.gu.Ot(e),_r(t).Wo(e)}function Gu(t){t.gu=new M0({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),ne:e=>t.fu.get(e)||null}),_r(t).start(),t.mu.ou()}function Qu(t){return xs(t)&&!_r(t).xo()&&t.fu.size>0}function xs(t){return ne(t).du.size===0}function gy(t){t.gu=void 0}async function DA(t){t.fu.forEach((e,n)=>{Wu(t,e)})}async function xA(t,e){gy(t),Qu(t)?(t.mu.au(e),Gu(t)):t.mu.set("Unknown")}async function MA(t,e,n){if(t.mu.set("Online"),e instanceof ty&&e.state===2&&e.cause)try{await async function(s,r){const i=r.cause;for(const o of r.targetIds)s.fu.has(o)&&(await s.remoteSyncer.rejectListen(o,i),s.fu.delete(o),s.gu.removeTarget(o))}(t,e)}catch(s){B("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),s),await ra(t,s)}else if(e instanceof ko?t.gu.Kt(e):e instanceof ey?t.gu.Jt(e):t.gu.zt(e),!n.isEqual(Z.min()))try{const s=await ly(t.localStore);n.compareTo(s)>=0&&await function(r,i){const o=r.gu.Xt(i);return o.targetChanges.forEach((a,c)=>{if(a.resumeToken.approximateByteSize()>0){const l=r.fu.get(c);l&&r.fu.set(c,l.withResumeToken(a.resumeToken,i))}}),o.targetMismatches.forEach(a=>{const c=r.fu.get(a);if(!c)return;r.fu.set(a,c.withResumeToken(at.EMPTY_BYTE_STRING,c.snapshotVersion)),py(r,a);const l=new _s(c.target,a,1,c.sequenceNumber);Wu(r,l)}),r.remoteSyncer.applyRemoteEvent(o)}(t,n)}catch(s){B("RemoteStore","Failed to raise snapshot:",s),await ra(t,s)}}async function ra(t,e,n){if(!Vi(e))throw e;t.du.add(1),await qi(t),t.mu.set("Offline"),n||(n=()=>ly(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{B("RemoteStore","Retrying IndexedDB access"),await n(),t.du.delete(1),await Qa(t)})}function my(t,e){return e().catch(n=>ra(t,n,e))}async function Xa(t){const e=ne(t),n=Kn(e);let s=e.lu.length>0?e.lu[e.lu.length-1].batchId:-1;for(;LA(e);)try{const r=await wA(e.localStore,s);if(r===null){e.lu.length===0&&n.$o();break}s=r.batchId,UA(e,r)}catch(r){await ra(e,r)}yy(e)&&vy(e)}function LA(t){return xs(t)&&t.lu.length<10}function UA(t,e){t.lu.push(e);const n=Kn(t);n.No()&&n.Jo&&n.Yo(e.mutations)}function yy(t){return xs(t)&&!Kn(t).xo()&&t.lu.length>0}function vy(t){Kn(t).start()}async function FA(t){Kn(t).tu()}async function $A(t){const e=Kn(t);for(const n of t.lu)e.Yo(n.mutations)}async function BA(t,e,n){const s=t.lu.shift(),r=Vu.from(s,e,n);await my(t,()=>t.remoteSyncer.applySuccessfulWrite(r)),await Xa(t)}async function VA(t,e){e&&Kn(t).Jo&&await async function(n,s){if(r=s.code,x0(r)&&r!==I.ABORTED){const i=n.lu.shift();Kn(n).Oo(),await my(n,()=>n.remoteSyncer.rejectFailedWrite(i.batchId,s)),await Xa(n)}var r}(t,e),yy(t)&&vy(t)}async function Yd(t,e){const n=ne(t);n.asyncQueue.verifyOperationInProgress(),B("RemoteStore","RemoteStore received new credentials");const s=xs(n);n.du.add(3),await qi(n),s&&n.mu.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.du.delete(3),await Qa(n)}async function jA(t,e){const n=ne(t);e?(n.du.delete(2),await Qa(n)):e||(n.du.add(2),await qi(n),n.mu.set("Unknown"))}function _r(t){return t.yu||(t.yu=function(e,n,s){const r=ne(e);return r.nu(),new kA(n,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,s)}(t.datastore,t.asyncQueue,{Jr:DA.bind(null,t),Zr:xA.bind(null,t),zo:MA.bind(null,t)}),t.wu.push(async e=>{e?(t.yu.Oo(),Qu(t)?Gu(t):t.mu.set("Unknown")):(await t.yu.stop(),gy(t))})),t.yu}function Kn(t){return t.pu||(t.pu=function(e,n,s){const r=ne(e);return r.nu(),new RA(n,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,s)}(t.datastore,t.asyncQueue,{Jr:FA.bind(null,t),Zr:VA.bind(null,t),Xo:$A.bind(null,t),Zo:BA.bind(null,t)}),t.wu.push(async e=>{e?(t.pu.Oo(),await Xa(t)):(await t.pu.stop(),t.lu.length>0&&(B("RemoteStore",`Stopping write stream with ${t.lu.length} pending writes`),t.lu=[]))})),t.pu}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jd{constructor(){this.Iu=new ze(H.comparator)}track(e){const n=e.doc.key,s=this.Iu.get(n);s?e.type!==0&&s.type===3?this.Iu=this.Iu.insert(n,e):e.type===3&&s.type!==1?this.Iu=this.Iu.insert(n,{type:s.type,doc:e.doc}):e.type===2&&s.type===2?this.Iu=this.Iu.insert(n,{type:2,doc:e.doc}):e.type===2&&s.type===0?this.Iu=this.Iu.insert(n,{type:0,doc:e.doc}):e.type===1&&s.type===0?this.Iu=this.Iu.remove(n):e.type===1&&s.type===2?this.Iu=this.Iu.insert(n,{type:1,doc:s.doc}):e.type===0&&s.type===1?this.Iu=this.Iu.insert(n,{type:2,doc:e.doc}):X():this.Iu=this.Iu.insert(n,e)}Tu(){const e=[];return this.Iu.inorderTraversal((n,s)=>{e.push(s)}),e}}class ur{constructor(e,n,s,r,i,o,a,c,l){this.query=e,this.docs=n,this.oldDocs=s,this.docChanges=r,this.mutatedKeys=i,this.fromCache=o,this.syncStateChanged=a,this.excludesMetadataChanges=c,this.hasCachedResults=l}static fromInitialDocuments(e,n,s,r,i){const o=[];return n.forEach(a=>{o.push({type:0,doc:a})}),new ur(e,n,er.emptySet(n),o,s,r,!0,!1,i)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&Ha(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const n=this.docChanges,s=e.docChanges;if(n.length!==s.length)return!1;for(let r=0;r<n.length;r++)if(n[r].type!==s[r].type||!n[r].doc.isEqual(s[r].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rt{constructor(e,n,s){this.converter=n,this._key=s,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new $n(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Rt(this.firestore,e,this._key)}}class Ja{constructor(e,n,s){this.converter=n,this._query=s,this.type="query",this.firestore=e}withConverter(e){return new Ja(this.firestore,e,this._query)}}class $n extends Ja{constructor(e,n,s){super(e,n,Um(s)),this._path=s,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Rt(this.firestore,null,new H(e))}withConverter(e){return new $n(this.firestore,e,this._path)}}function wP(t,e,...n){if(t=xe(t),Sy("collection","path",e),t instanceof Ya){const s=Ce.fromString(e,...n);return of(s),new $n(t,null,s)}{if(!(t instanceof Rt||t instanceof $n))throw new K(I.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=t._path.child(Ce.fromString(e,...n));return of(s),new $n(t.firestore,null,s)}}function bP(t,e,...n){if(t=xe(t),arguments.length===1&&(e=Sm.A()),Sy("doc","path",e),t instanceof Ya){const s=Ce.fromString(e,...n);return rf(s),new Rt(t,null,new H(s))}{if(!(t instanceof Rt||t instanceof $n))throw new K(I.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=t._path.child(Ce.fromString(e,...n));return rf(s),new Rt(t.firestore,t instanceof $n?t.converter:null,new H(s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sf=new fu("@firebase/auth");function Oo(t,...e){Sf.logLevel<=pe.ERROR&&Sf.error(`Auth (${fr}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cf=new Map;function ln(t){_n(t instanceof Function,"Expected a class definition");let e=Cf.get(t);return e?(_n(e instanceof t,"Instance stored in cache mismatched with class"),e):(e=new t,Cf.set(t,e),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $l(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.href)||""}function jk(){return kf()==="http:"||kf()==="https:"}function kf(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lv{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,n){this.storage[e]=n}async _get(e){const n=this.storage[e];return n===void 0?null:n}async _remove(e){delete this.storage[e]}_addListener(e,n){}_removeListener(e,n){}}lv.type="NONE";const Rf=lv;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Of(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(dv(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(uv(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(pv(e))return"Blackberry";if(gv(e))return"Webos";if(dh(e))return"Safari";if((e.includes("chrome/")||hv(e))&&!e.includes("edge/"))return"Chrome";if(fv(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=t.match(n);if((s==null?void 0:s.length)===2)return s[1]}return"Other"}function uv(t=ot()){return/firefox\//i.test(t)}function dh(t=ot()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function hv(t=ot()){return/crios\//i.test(t)}function dv(t=ot()){return/iemobile/i.test(t)}function fv(t=ot()){return/android/i.test(t)}function pv(t=ot()){return/blackberry/i.test(t)}function gv(t=ot()){return/webos/i.test(t)}function ec(t=ot()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function rR(t=ot()){var e;return ec(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function iR(){return bE()&&document.documentMode===10}function mv(t=ot()){return ec(t)||fv(t)||gv(t)||pv(t)||/windows phone/i.test(t)||dv(t)}function oR(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yv(t,e=[]){let n;switch(t){case"Browser":n=Of(ot());break;case"Worker":n=`${Of(ot())}-${t}`;break;default:n=t}const s=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${fr}/${s}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ks{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,n,s,r=!1){const i=await ws._fromIdTokenResponse(e,s,r),o=Df(s);return new ks({user:i,providerId:o,_tokenResponse:s,operationType:n})}static async _forOperation(e,n,s){await e._updateTokensIfNecessary(s,!0);const r=Df(s);return new ks({user:e,providerId:r,_tokenResponse:s,operationType:n})}}function Df(t){return t.providerId?t.providerId:"phoneNumber"in t?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bR(t,e,n=!1){const{auth:s}=t,r="reauthenticate";try{const i=await _i(t,wv(s,r,e,t),n);G(i.idToken,s,"internal-error");const o=hh(i.idToken);G(o,s,"internal-error");const{sub:a}=o;return G(t.uid===a,s,"user-mismatch"),ks._forOperation(t,r,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&Ut(s,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bv(t,e,n=!1){const s="signIn",r=await wv(t,s,e),i=await ks._fromIdTokenResponse(t,s,r);return n||await t._updateCurrentUser(i.user),i}async function ER(t,e){return bv(Xi(t),e)}async function AP(t,e,n){const s=Xi(t),r=await _R(s,{returnSecureToken:!0,email:e,password:n}),i=await ks._fromIdTokenResponse(s,"signIn",r);return await s._updateCurrentUser(i.user),i}function SP(t,e,n){return ER(xe(t),wr.credential(e,n))}function TR(t,e,n,s){return xe(t).onIdTokenChanged(e,n,s)}function IR(t,e,n){return xe(t).beforeAuthStateChanged(e,n)}function CP(t){return xe(t).signOut()}const ca="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uO=new Ki(3e4,6e4);function Uf(){const t=Gt().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function hO(t){return new Promise((e,n)=>{var s,r,i;function o(){Uf(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Uf(),n(Wt(t,"network-request-failed"))},timeout:uO.get()})}if(!((r=(s=Gt().gapi)===null||s===void 0?void 0:s.iframes)===null||r===void 0)&&r.Iframe)e(gapi.iframes.getContext());else if(!((i=Gt().gapi)===null||i===void 0)&&i.load)o();else{const a=HR("iframefcb");return Gt()[a]=()=>{gapi.load?o():n(Wt(t,"network-request-failed"))},jR(`https://apis.google.com/js/api.js?onload=${a}`).catch(c=>n(c))}}).catch(e=>{throw Do=null,e})}let Do=null;function dO(t){return Do=Do||hO(t),Do}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wO={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},bO=500,EO=600,TO="_blank",IO="http://localhost";class Ff{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function AO(t,e,n,s=bO,r=EO){const i=Math.max((window.screen.availHeight-r)/2,0).toString(),o=Math.max((window.screen.availWidth-s)/2,0).toString();let a="";const c=Object.assign(Object.assign({},wO),{width:s.toString(),height:r.toString(),top:i,left:o}),l=ot().toLowerCase();n&&(a=hv(l)?TO:n),uv(l)&&(e=e||IO,c.scrollbars="yes");const u=Object.entries(c).reduce((d,[p,m])=>`${d}${p}=${m},`,"");if(rR(l)&&a!=="_self")return SO(e||"",a),new Ff(null);const h=window.open(e||"",a,u);G(h,t,"popup-blocked");try{h.focus()}catch{}return new Ff(h)}function SO(t,e){const n=document.createElement("a");n.href=t,n.target=e;const s=document.createEvent("MouseEvent");s.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(s)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const MO=5*60,LO=mg("authIdTokenMaxAge")||MO;let jf=null;const UO=t=>async e=>{const n=e&&await e.getIdTokenResult(),s=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(s&&s>LO)return;const r=n==null?void 0:n.token;jf!==r&&(jf=r,await fetch(t,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))};function FO(t=Aa()){const e=Oi(t,"auth");if(e.isInitialized())return e.getImmediate();const n=Bk(t,{popupRedirectResolver:NO,persistence:[BR,kR,Av]}),s=mg("authTokenSyncURL");if(s){const i=UO(s);IR(n,i,()=>i(n.currentUser)),TR(n,o=>i(o))}const r=gg("auth");return r&&lR(n,`http://${r}`),n}xO("Browser");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sN(t){return t!==void 0}function rN(t){return typeof t=="function"}function iN(t){return typeof t=="object"&&!Array.isArray(t)}function sc(t){return typeof t=="string"||t instanceof String}function Hf(t){return vh()&&t instanceof Blob}function vh(){return typeof Blob<"u"&&!vE()}function jl(t,e,n,s){if(s<e)throw Vl(`Invalid value for '${t}'. Expected ${e} or greater.`);if(s>n)throw Vl(`Invalid value for '${t}'. Expected ${n} or less.`)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dn{constructor(e,n){let s=0,r="";Hf(e)?(this.data_=e,s=e.size,r=e.type):e instanceof ArrayBuffer?(n?this.data_=new Uint8Array(e):(this.data_=new Uint8Array(e.byteLength),this.data_.set(new Uint8Array(e))),s=this.data_.length):e instanceof Uint8Array&&(n?this.data_=e:(this.data_=new Uint8Array(e.length),this.data_.set(e)),s=e.length),this.size_=s,this.type_=r}size(){return this.size_}type(){return this.type_}slice(e,n){if(Hf(this.data_)){const s=this.data_,r=pN(s,e,n);return r===null?null:new Dn(r)}else{const s=new Uint8Array(this.data_.buffer,e,n-e);return new Dn(s,!0)}}static getBlob(...e){if(vh()){const n=e.map(s=>s instanceof Dn?s.data_:s);return new Dn(fN.apply(null,n))}else{const n=e.map(o=>sc(o)?mN(zt.RAW,o).data:o.data_);let s=0;n.forEach(o=>{s+=o.byteLength});const r=new Uint8Array(s);let i=0;return n.forEach(o=>{for(let a=0;a<o.length;a++)r[i++]=o[a]}),new Dn(r,!0)}}uploadData(){return this.data_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function TN(t,e){return e}class lt{constructor(e,n,s,r){this.server=e,this.local=n||e,this.writable=!!s,this.xform=r||TN}}let vo=null;function IN(t){return!sc(t)||t.length<2?t:Hv(t)}function qv(){if(vo)return vo;const t=[];t.push(new lt("bucket")),t.push(new lt("generation")),t.push(new lt("metageneration")),t.push(new lt("name","fullPath",!0));function e(i,o){return IN(o)}const n=new lt("name");n.xform=e,t.push(n);function s(i,o){return o!==void 0?Number(o):o}const r=new lt("size");return r.xform=s,t.push(r),t.push(new lt("timeCreated")),t.push(new lt("updated")),t.push(new lt("md5Hash",null,!0)),t.push(new lt("cacheControl",null,!0)),t.push(new lt("contentDisposition",null,!0)),t.push(new lt("contentEncoding",null,!0)),t.push(new lt("contentLanguage",null,!0)),t.push(new lt("contentType",null,!0)),t.push(new lt("metadata","customMetadata",!0)),vo=t,vo}function AN(t,e){function n(){const s=t.bucket,r=t.fullPath,i=new pt(s,r);return e._makeStorageReference(i)}Object.defineProperty(t,"ref",{get:n})}function SN(t,e,n){const s={};s.type="file";const r=n.length;for(let i=0;i<r;i++){const o=n[i];s[o.local]=o.xform(s,e[o.server])}return AN(s,t),s}function zv(t,e,n){const s=_h(e);return s===null?null:SN(t,s,n)}function CN(t,e,n,s){const r=_h(e);if(r===null||!sc(r.downloadTokens))return null;const i=r.downloadTokens;if(i.length===0)return null;const o=encodeURIComponent;return i.split(",").map(l=>{const u=t.bucket,h=t.fullPath,d="/b/"+o(u)+"/o/"+o(h),p=Ms(d,n,s),m=Fv({alt:"media",token:l});return p+m})[0]}function Kv(t,e){const n={},s=e.length;for(let r=0;r<s;r++){const i=e[r];i.writable&&(n[i.server]=t[i.local])}return JSON.stringify(n)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,d=`\r
--`+c+"--",p=Dn.getBlob(h,s,d);if(p===null)throw Lv();const m={name:l.fullPath},v=Ms(i,t.host,t._protocol),w="POST",C=t.maxUploadRetryTime,O=new Yn(v,w,wh(t,n),C);return O.urlParams=m,O.headers=o,O.body=p.uploadData(),O.errorHandler=br(e),O}class ua{constructor(e,n,s,r){this.current=e,this.total=n,this.finalized=!!s,this.metadata=r||null}}function Eh(t,e){let n=null;try{n=t.getResponseHeader("X-Goog-Upload-Status")}catch{Qt(!1)}return Qt(!!n&&(e||["active"]).indexOf(n)!==-1),n}function FN(t,e,n,s,r){const i=e.bucketOnlyServerUrl(),o=Wv(e,s,r),a={name:o.fullPath},c=Ms(i,t.host,t._protocol),l="POST",u={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${s.size()}`,"X-Goog-Upload-Header-Content-Type":o.contentType,"Content-Type":"application/json; charset=utf-8"},h=Kv(o,n),d=t.maxUploadRetryTime;function p(v){Eh(v);let w;try{w=v.getResponseHeader("X-Goog-Upload-URL")}catch{Qt(!1)}return Qt(sc(w)),w}const m=new Yn(c,l,p,d);return m.urlParams=a,m.headers=u,m.body=h,m.errorHandler=br(e),m}function $N(t,e,n,s){const r={"X-Goog-Upload-Command":"query"};function i(l){const u=Eh(l,["active","final"]);let h=null;try{h=l.getResponseHeader("X-Goog-Upload-Size-Received")}catch{Qt(!1)}h||Qt(!1);const d=Number(h);return Qt(!isNaN(d)),new ua(d,s.size(),u==="final")}const o="POST",a=t.maxUploadRetryTime,c=new Yn(n,o,i,a);return c.headers=r,c.errorHandler=br(e),c}const Kf=256*1024;function BN(t,e,n,s,r,i,o,a){const c=new ua(0,0);if(o?(c.current=o.current,c.total=o.total):(c.current=0,c.total=s.size()),s.size()!==c.total)throw XO();const l=c.total-c.current;let u=l;r>0&&(u=Math.min(u,r));const h=c.current,d=h+u;let p="";u===0?p="finalize":l===u?p="upload, finalize":p="upload";const m={"X-Goog-Upload-Command":p,"X-Goog-Upload-Offset":`${c.current}`},v=s.slice(h,d);if(v===null)throw Lv();function w(P,q){const ue=Eh(P,["active","final"]),Te=c.current+u,z=s.size();let re;return ue==="final"?re=wh(e,i)(P,q):re=null,new ua(Te,z,ue==="final",re)}const C="POST",O=e.maxUploadRetryTime,D=new Yn(n,C,w,O);return D.headers=m,D.body=v.uploadData(),D.progressCallback=a||null,D.errorHandler=br(t),D}const yt={RUNNING:"running",PAUSED:"paused",SUCCESS:"success",CANCELED:"canceled",ERROR:"error"};function Mc(t){switch(t){case"running":case"pausing":case"canceling":return yt.RUNNING;case"paused":return yt.PAUSED;case"success":return yt.SUCCESS;case"canceled":return yt.CANCELED;case"error":return yt.ERROR;default:return yt.ERROR}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qv="storage";function kP(t,e,n){return t=xe(t),zN(t,e,n)}function RP(t,e){return t=xe(t),KN(t,e)}function OP(t){return t=xe(t),WN(t)}function NP(t){return t=xe(t),GN(t)}function PP(t,e){return t=xe(t),JN(t,e)}function eP(t=Aa(),e){t=xe(t);const s=Oi(t,Qv).getImmediate({identifier:e}),r=du("storage");return r&&tP(s,...r),s}function tP(t,e,n,s={}){ZN(t,e,n,s)}function nP(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),r=t.getProvider("app-check-internal");return new Th(n,s,r,e,fr)}function sP(){Hn(new pn(Qv,nP,"PUBLIC").setMultipleInstances(!0)),kt(Gf,Qf,""),kt(Gf,Qf,"esm2017")}sP();/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const aP="auth-internal",cP="app-check-internal",lP="messaging-internal";function uP(t,e){const n=(s,{instanceIdentifier:r})=>{const i=s.getProvider("app").getImmediate(),o=s.getProvider(aP),a=s.getProvider(lP),c=s.getProvider(cP);return new iP(i,o,a,c,r,t)};Hn(new pn(Xv,n,"PUBLIC").setMultipleInstances(!0)),kt(Xf,Yf,e),kt(Xf,Yf,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hP(t=Aa(),e=Hl){const s=Oi(xe(t),Xv).getImmediate({identifier:e}),r=du("functions");return r&&dP(s,...r),s}function dP(t,e,n){oP(xe(t),e,n)}uP(fetch.bind(self));const fP={apiKey:"AIzaSyBDevPI9maQg7zZPO4rUDHj7ZMENqdw3vE",authDomain:"closetsnap-822e7.firebaseapp.com",projectId:"closetsnap-822e7",storageBucket:"closetsnap-822e7.appspot.com",messagingSenderId:"604567787747",appId:"1:604567787747:web:173093122cebf15280cdd6"},Ih=wg(fP);FO(Ih);eP(Ih);hP(Ih);let pP=Ok({history:RC(),routes:Mk});const Yv=eE(rC);Yv.use(pP);Yv.mount("#app");export{It as F,hu as _,yP as a,eP as b,nl as c,OP as d,We as e,NP as f,FO as g,gP as h,Xh as i,AP as j,IP as k,RP as l,bP as m,mP as n,Vr as o,ql as p,ZS as q,PP as r,wP as s,TP as t,kP as u,vP as v,EP as w,ih as x,SP as y,CP as z};
